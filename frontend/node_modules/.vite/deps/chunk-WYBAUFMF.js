...
var g = class extends d {
  ...
  async _fetchServiceDefinition(e) {
    const r3 = { f: "json", ...this._config.customParameters }, i2 = H(e.path, { query: r3, responseType: "json" }), o4 = (await i2).data;
  ...
  async _queryBuddy(e) {
    const t = new (await import("./FeatureLayer-6AT5WKG5.js")).default({ url: e }), { capabilities: r3 } = await t.load(), i2 = r3.query.supportsMaxRecordCountFactor, o4 = r3.query.supportsPagination, s2 = r3.query.supportsCentroid, n = this._config.maxRecordCountFactor, c3 = t.capabilities.query.maxRecordCount, u = i2 ? c3 * n : c3, h3 = new R();
...
//# sourceMappingURL=chunk-WYBAUFMF.js.map
