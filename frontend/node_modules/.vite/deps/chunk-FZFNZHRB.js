...
async function I(e2, r) {
  ...
  if ("object" == typeof t) {
    ...
    const n2 = await r.fetchServiceMetadata(c2, { customParameters: await r.fetchCustomParameters(e2, ((e3) => s4(e3)?.customParameters)) });
...
async function A2(e2, a2, t) {
  ...
  if (/\/\d+$/.test(s5)) {
    if (i2) {
      const t2 = await a2.fetchServiceMetadata(s5, { customParameters: await a2.fetchCustomParameters(e2, ((e3) => s4(e3)?.customParameters)) });
...
//# sourceMappingURL=chunk-FZFNZHRB.js.map
