...
async function n3(o3, s, n4, p) {
  const i2 = f(o3), u2 = { ...n4 }, m = R.from(s), f3 = !m.quantizationParameters, { data: c } = await f2(i2, m, new d({ sourceSpatialReference: m.sourceSpatialReference, applyTransform: f3 }), u2, p);
  return c;
}
...
//# sourceMappingURL=chunk-DR7CKJIZ.js.map
