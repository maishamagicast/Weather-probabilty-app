...
var a8 = class extends l {
  ...
  async getRequiredFields(e4) {
    ...
    return await this.collectRequiredFields(r4, e4), Array.from(r4).sort();
  }
  getSymbol(e4, r4) {
  }
...
var v4 = (l4) => {
  let u7 = class extends l4 {
    ...
    async collectVVRequiredFields(r4, a13) {
      let s5 = [];
      this.visualVariables && (s5 = s5.concat(this.visualVariables));
      for (const i10 of s5) i10 && (i10.field && x3(r4, a13, i10.field), i10.normalizationField && x3(r4, a13, i10.normalizationField), i10.valueExpression && (y3(i10.valueExpression, r4, a13) || await E(r4, a13, i10.valueExpression)));
    }
  };
...
//# sourceMappingURL=chunk-JLGVQWP5.js.map
