...
var m5 = class extends $ {
  ...
  async _updateClipGeometry() {
    ...
    if (e2 && "inside" === t2.clippingType) {
      const { extent: t3 } = this.rasterInfo, r6 = await import("./densifyOperator-2BLVWV23.js"), s3 = await import("./differenceOperator-HSH7C4VR.js");
    ...
    async _getSampleLocations(e2) {
      ...
      if ("polyline" === r6) {
        ...
        if (e2.sampleCount || e2.sampleDistance) {
          const i7 = await import("./densifyOperator-2BLVWV23.js"), s4 = (await import("./lengthOperator-II4YUFRY.js")).execute(t2, { unit: "meters" }), n3 = Math.min(e2.sampleCount || 100, Q3);
...
//# sourceMappingURL=chunk-6DCZ7G4M.js.map
