...
import {
  g as g2,
  g2 as g3
} from "./chunk-P2AUZKEC.js";
import {
  n as n5,
  p as p4,
  s as s5
} from "./chunk-5VVUP5GE.js";
...
import {
  r as r8
} from "./chunk-S2VGA2VC.js";
import "./chunk-IE6QJMDY.js";
import {
  r as r9
} from "./chunk-YZLQYTEZ.js";
import {
  r as r6
} from "./chunk-NYQFXO4S.js";
import {
  r as r7
} from "./chunk-M4WI67SO.js";
...
var x3 = class extends o.EventedMixin(b) {
  ...
  async _createSelfSnappingEngine(e6) {
    const [{ SelfSnappingEngine: t3 }, n10] = await Promise.all([import("./SelfSnappingEngine-WJRMIXSK.js"), g4()]);
  ...
  async _createGridSnappingEngine(e6) {
    ...
    const { GridSnappingEngine: n10 } = await import("./GridSnappingEngine-64YLFKC3.js");
    return s2(e6), { type: "grid", engine: new n10({ view: t3, options: this.options }) };
  }
  async _createFeatureSnappingEngine(e6) {
    const { FeatureSnappingEngine: t3 } = await import("./FeatureSnappingEngine-3TQHFUS5.js");
    s2(e6);
...
async function o4() {
  const e6 = await import("./geometryEngine-RNKPGZNV.js");
  return s6(e6);
}
function n6(t3) {
...
var re = class extends o.EventedAccessor {
  ...
  initialize() {
    this.addHandles([a2((() => this.view?.map?.layers), "change", ((e6) => {
      ...
      this._defaultSnappingManager = u(this._defaultSnappingManager), e6 && (this.snappingManager || (this._defaultSnappingManager = new x3({ view: e6, options: this.snappingOptions })), "2d" === e6.type ? import("./editingTools-IRDPNKN4.js") : "3d" === e6.type && (import("./editingTools-E7WCQBA4.js"), import("./GraphicsLayerView3D-BYMSVOYT.js")));
  ...
  async _makeDrawGraphicTool2D(e6) {
    const [t3, o6, i4] = await Promise.all([this._requireModule(import("./editingTools-IRDPNKN4.js")), u5(), c8()]);
  ...
  async _makeDrawGraphicTool3D(e6) {
    const [t3, o6, i4] = await Promise.all([this._requireModule(import("./editingTools-E7WCQBA4.js")), u5(), c8()]);
  ...
  async _setupMove3DOperation(e6, t3, o6, i4, s8 = false) {
    const [r12, n10] = await Promise.all([this._requireModule(import("./editingTools-E7WCQBA4.js")), c8()]);
  ...
  async _setupPointTransform3DOperation(e6, t3, o6) {
    const i4 = "transform", { enableRotation: s8, enableScaling: r12, enableZ: n10 } = t3, p8 = await this._requireModule(import("./editingTools-E7WCQBA4.js"));
    if (ge(p8)) return p8;
  ...
  async _setupPolyTransform3DOperation(e6, t3, o6, i4 = false) {
    const s8 = "transform", { enableRotation: r12, enableScaling: n10, enableZ: p8, preserveAspectRatio: l9 } = t3, [h8, c9] = await Promise.all([this._requireModule(import("./editingTools-E7WCQBA4.js")), c8()]);
    if (ge(h8)) return h8;
  ...
  async _setupReshape3DOperation(e6, t3, o6, i4 = false) {
    const s8 = "reshape", [r12, n10, p8] = await Promise.all([this._requireModule(import("./editingTools-E7WCQBA4.js")), u5(), c8()]);
    if (ge(r12)) return r12;
  ...
  async _getGraphicMover(e6, t3, o6) {
    const { enableMoveAllGraphics: i4, highlightOptions: a8 } = t3, s8 = await this._requireModule(import("./GraphicMover-XWRRHS6R.js"));
  ...
  async _getBox(e6, t3, o6) {
    const { enableRotation: i4, enableScaling: a8, highlightOptions: s8, preserveAspectRatio: r12 } = t3, [n10, p8] = await Promise.all([this._requireModule(import("./Box-EQJA63GV.js")), c8()]);
  ...
  async _getReshape(e6, t3, o6) {
    const { highlightOptions: i4, reshapeOptions: a8 } = t3, s8 = "split" === a8?.edgeOperation, r12 = "move" === a8?.shapeOperation, [n10, p8, l9] = await Promise.all([this._requireModule(import("./Reshape-MVMY2UHD.js")), u5(), c8()]);
...
//# sourceMappingURL=RouteLayerInteraction-PD2YGMWZ.js.map
