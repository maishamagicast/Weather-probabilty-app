  ...
  if (Array.isArray(t2) && 2 === t2.length && "number" == typeof t2[0] && "number" == typeof t2[1]) a5 = new _(t2);
    ...
    if (t2.geometry) a5 = t2.geometry;
      ...
      if (n4 && "queryFeatures" in n4) {
        ...
        const o4 = await n4.queryFeatures(r7);
...
async function Y(e3, r6) {
  ...
  let l6 = null;
  u4?.targetGeometry ? l6 = u4.targetGeometry : e3 instanceof z ? l6 = e3 : e3 instanceof c ? l6 = await J(e3, r6, n3) : e3 && (l6 = await J(e3.center, r6, n3) || await J(e3.target, r6, n3) || await J(e3, r6, n3)), !l6 && i2?.targetGeometry ? l6 = i2.targetGeometry : !l6 && r6.extent && (l6 = r6.extent), n3 || (n3 = B2(r6.spatialReference || r6.extent || l6)), k() || s2(l6.spatialReference, n3) || L(l6.spatialReference, n3) || await K();
...
//# sourceMappingURL=chunk-IR53UIF6.js.map
