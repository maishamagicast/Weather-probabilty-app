...
function l(t) {
  if (null != t && !_(t)) {
    let e2 = Number(t);
    return o2(e2) && g(t) && "" != t && t.match(/[0-9]+/) ? l(t.replace(/[^0-9.\-]+/g, "")) : e2;
  }
  return t;
}
function d(t) {
...
function St(t, e2 = false) {
  const i2 = Tt(new Date(t.getFullYear(), t.getMonth(), 1), e2);
  let s2 = Tt(t, e2);
...
function It(t, e2) {
  return t ? { r: Math.max(0, Math.min(255, t.r + Lt(t.r, e2))), g: Math.max(0, Math.min(255, t.g + Lt(t.g, e2))), b: Math.max(0, Math.min(255, t.b + Lt(t.b, e2))), a: t.a } : t;
}
function Lt(t, e2) {
  let i2 = e2 > 0 ? 255 - t : t;
...
var Yt = class _Yt {
  ...
  toHSL(t = 1) {
    return Ht({ r: this.r, g: this.g, b: this.b });
  }
...
var se = class {
  ...
  _onSwap(t, e2) {
    this.events.isEnabled("swap") && this.events.dispatch("swap", { type: "swap", target: this, a: t, b: e2 });
  }
  _onRemoveIndex(t, e2) {
  ...
  swap(t, e2) {
    ...
    if (ie(t, i2), ie(e2, i2), t !== e2) {
      ...
      this._values[t] = s2, this._values[e2] = i3, this._onSwap(i3, s2);
    }
  }
  removeIndex(t) {
    ie(t, this._values.length);
...
var re = class extends se {
  ...
  swap(t, e2) {
    const i2 = this.autoDispose;
    this.autoDispose = false, super.swap(t, e2), this.autoDispose = i2;
  }
  _onSetIndex(t, e2, i2) {
...
var Ce = class {
  ...
  add(t, e2) {
    ...
    return void 0 === i2 && (i2 = this._callbacks[t] = []), i2.push(e2), this._entity._markDirtyKey(t), new z((() => {
      T(i2, e2) && this._entity._markDirtyKey(t);
    }));
  }
  remove(t) {
...
var Ae = class {
  ...
  on(t, e2) {
    ...
    return void 0 === i2 && (i2 = this._settingEvents[t] = []), i2.push(e2), new z((() => {
      T(i2, e2), 0 === i2.length && delete this._settingEvents[t];
    }));
  }
  off(t, e2) {
    let i2 = this._settingEvents[t];
    void 0 !== i2 && void 0 !== e2 ? T(i2, e2) : delete this._settingEvents[t];
  }
  onPrivate(t, e2) {
    let i2 = this._privateSettingEvents[t];
    return void 0 === i2 && (i2 = this._privateSettingEvents[t] = []), i2.push(e2), new z((() => {
      T(i2, e2), 0 === i2.length && delete this._privateSettingEvents[t];
    }));
  }
  offPrivate(t, e2) {
    let i2 = this._privateSettingEvents[t];
    void 0 !== i2 && void 0 !== e2 ? T(i2, e2) : delete this._privateSettingEvents[t];
  }
  getRaw(t, e2) {
    const i2 = this._settings[t];
    return void 0 !== i2 ? i2 : e2;
...
var He = class extends Ae {
  ...
  _beforeChanged() {
    if (this.isDirty("id")) {
      ...
      e2 && (delete this._root.entitiesById[e2], delete Te.entitiesById[e2]);
    }
  }
  _registerId(t) {
    if (this._root.entitiesById[t] && this._root.entitiesById[t] !== this) throw new Error('An entity with id "' + t + '" already exists.');
    this._root.entitiesById[t] = this, Te.entitiesById[t] = this;
  }
  _afterChanged() {
  }
  addDisposer(t) {
...
var Re = class {
  ...
  add(t, e2) {
    ...
    return void 0 === i2 && (i2 = this._callbacks[t] = []), i2.push(e2), new z((() => {
      T(i2, e2), 0 === i2.length && delete this._callbacks[t];
    }));
  }
  remove(t) {
...
var Ue = class extends He {
  ...
  _addPercentageSizeChildren() {
    let t = this.parent;
    t && (this.get("width") instanceof e || this.get("height") instanceof e ? S(t._percentageSizeChildren, this) : T(t._percentageSizeChildren, this));
  }
  _addPercentagePositionChildren() {
    let t = this.parent;
    t && (this.get("x") instanceof e || this.get("y") instanceof e ? S(t._percentagePositionChildren, this) : T(t._percentagePositionChildren, this));
  }
  markDirtyPosition() {
  ...
  _changed() {
    ...
    }))), this._disposers.push(i2.once("boundschanged", (() => {
  ...
  markDirtyBounds() {
    ...
    if (this.get("isMeasured")) {
      ...
      const e2 = this.parent;
      e2 && "absolute" != this.get("position") && (null == e2.get("width") || null == e2.get("height") || e2.get("layout")) && e2.markDirtyBounds(), this.get("focusable") && this.markDirtyAccessibility();
    }
  }
  ...
  _removeParent(t) {
    t && (t.children.removeValue(this), T(t._percentageSizeChildren, this), T(t._percentagePositionChildren, this));
  }
  _clearDirty() {
  ...
  showTooltip(t) {
    if (!this.isDisposed()) {
      ...
      if ((i2 || s2) && e2) {
        ...
        if ("fixed" != r2 && t || (this._display._setMatrix(), t = this.toGlobal(a2._getTooltipPoint())), "pointer" == r2) {
          const e3 = this.getPrivate("lastTooltipCoords");
          if (e3 && e3.x == t.x && e3.y == t.y) return;
          this.setPrivate("lastTooltipCoords", t);
        }
        e2.set("pointTo", t), e2.set("tooltipTarget", a2), e2.get("x") || e2.set("x", t.x), e2.get("y") || e2.set("y", t.y), i2 && e2.label.set("text", i2), s2 && e2.label.set("html", s2);
...
//# sourceMappingURL=chunk-HAYNR2WC.js.map
