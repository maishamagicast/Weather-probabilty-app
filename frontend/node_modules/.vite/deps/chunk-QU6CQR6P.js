...
async function f5(e5, t5, n5) {
  const { source: o4 } = t5, { loadGLTFMesh: i6 } = await h(import("./loadGLTFMesh-QLKDBH3Y.js"), n5), l4 = await p4(o4, n5);
  s2(n5);
...
function x4(t5, e5, r5) {
  ...
  return { vertexAttributes: new p3({ ...c8, uv: t5.uv }), vertexSpace: n5, components: [new h3({ faces: t5.faces, material: r5?.material || null })], spatialReference: e5.spatialReference };
}
function y2(t5) {
...
var q2 = H2 = class extends p.LoadableMixin(m3.EsriPromiseMixin(c2)) {
  ...
  async toBinaryGLTF(e5) {
    const [{ toBinaryGLTF: t5 }] = await Promise.all([import("./gltfexport-JG57UGYI.js"), this.load(e5)]);
  ...
  static async createFromGLTF(e5, t5, r5) {
    ...
    const { loadGLTFMesh: s4 } = await h(import("./loadGLTFMesh-QLKDBH3Y.js"), r5);
...
//# sourceMappingURL=chunk-QU6CQR6P.js.map
