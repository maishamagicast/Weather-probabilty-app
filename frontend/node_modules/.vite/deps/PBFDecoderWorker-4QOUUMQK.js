...
var t2 = class {
  _parseFeatureQuery(t3) {
    const s2 = new _(t3.options), i = t(t3.buffer, s2), o2 = { ...i, spatialReference: i.spatialReference?.toJSON(), fields: i.fields ? i.fields.map(((e2) => e2.toJSON())) : void 0, missingAttributes: s2.missingAttributes };
...
//# sourceMappingURL=PBFDecoderWorker-4QOUUMQK.js.map
