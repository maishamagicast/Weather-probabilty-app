...
function v(t4, n2) {
  return t4 ? n2 && "function" == typeof n2 ? Object.keys(t4).map(((e2) => encodeURIComponent(e2) + "=" + encodeURIComponent(n2(e2, t4[e2])))).join("&") : Object.keys(t4).map(((e2) => {
    ...
    return i2 ? s4 + encodeURIComponent(i2(r2)) : Array.isArray(r2) ? r2.map(((t5) => t(t5) ? s4 + encodeURIComponent(JSON.stringify(t5)) : s4 + encodeURIComponent(t5))).join("&") : t(r2) ? s4 + encodeURIComponent(JSON.stringify(r2)) : s4 + encodeURIComponent(r2);
  })).filter(((t5) => t5)).join("&") : "";
}
function P(t4 = false) {
...
async function it(t4) {
  return (await fetch(t4)).blob();
}
function ut(t4) {
  const n2 = nt(t4);
  if (!n2) return null;
...
//# sourceMappingURL=chunk-OUZJZB6I.js.map
