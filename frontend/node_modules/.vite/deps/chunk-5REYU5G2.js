...
var r2 = class {
  ...
  remove(t2) {
    const i = y(this.data, r(t2), this.length, this._hint);
    if (-1 !== i) return this.data.splice(i, 1), this.length = this.length - 1, t2;
  }
  removeUnordered(t2) {
    return this.removeUnorderedIndex(y(this.data, r(t2), this.length, this._hint));
  }
...
//# sourceMappingURL=chunk-5REYU5G2.js.map
