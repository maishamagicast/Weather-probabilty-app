...
var a2 = class extends j(S(h)) {
  ...
  initialize() {
    this.addResolvingPromise(new Promise(((r2, e) => {
      A((() => {
        const r3 = this.resourceInfo && (this.resourceInfo.layerType || this.resourceInfo.type);
        let s2 = "Unknown layer type";
        r3 && (s2 += " " + r3), e(new s("layer:unknown-layer-type", s2, { layerType: r3 }));
      }));
    })));
  }
  read(r2, o) {
    super.read({ resourceInfo: r2 }, o);
  }
  write(r2, o) {
    return null;
  }
};
r([m({ readOnly: true })], a2.prototype, "resourceInfo", void 0), r([m({ type: ["show", "hide"] })], a2.prototype, "listMode", void 0), r([m({ json: { read: false }, readOnly: true, value: "unknown" })], a2.prototype, "type", void 0), a2 = r([a("esri.layers.UnknownLayer")], a2);
var c = a2;
export {
  c as default
};
//# sourceMappingURL=UnknownLayer-5HSTMGLS.js.map
