...
var $ = class extends l {
  ...
  async _fetchPixels(e2, t2, i6, o3 = {}) {
    ...
    L && !this.rasterJobHandler && await v();
  ...
  _processIdentifyResult(e2, t2) {
    ...
    return { location: i6, value: null, dataSeries: u5.map(((e3, t3) => {
      const i7 = { value: 0 === x3?.[t3] ? null : a4.map(((e4) => e4[t3])), multidimensionalDefinition: e3.multidimensionalDefinition.map(((e4) => new p2({ ...e4, isSlice: true }))) };
...
var m5 = class extends $ {
  ...
  async fetchPixels(t2, e2, r6, s3 = {}) {
    ...
    if (!l7 || null == y3 || null == g4) {
      ...
      return s3.noClip || s3.requestRawData || null == y3 || !t3 || (y3 = await r3(y3, d3, t3)), { ...u5[0], pixelBlock: y3 };
    }
    ...
    return s3.noClip || s3.requestRawData || null == R || null == w2 || (R = await r3(R, t2, w2)), { extent: t2, srcExtent: u5[0].srcExtent, pixelBlock: R };
  }
  ...
  async _updateClipGeometry() {
    ...
    if (e2 && "inside" === t2.clippingType) {
      const { extent: t3 } = this.rasterInfo, r6 = await import("./densifyOperator-ABEDVICC.js"), s3 = await import("./differenceOperator-2K6M2I26.js");
...
var X2 = (X3) => {
  let Y = class extends X3 {
    ...
    async computeStatisticsHistograms(e2, t2) {
      await this.load(t2), e2 = m2(j4, e2).clone();
      ...
      const l7 = e2.pixelSize ?? new _2({ x: r6.pixelSize.x, y: r6.pixelSize.y, spatialReference: a4 }), { extent: m6, width: p6, height: c3 } = p(r6, n2, l7), d3 = await this.fetchPixels(m6, p6, c3, { ...t2, interpolation: "nearest" });
      if (null == d3.pixelBlock) throw new s("imagery-tile-mixin:compute-statistics-histograms", "failed to fetch pixels");
      const h6 = await r3(d3.pixelBlock, m6, n2), f3 = this._rasterJobHandler;
    ...
    async getSamples(e2, t2) {
      if (await this.load(), (e2 = m2(h3, e2).clone()).interpolation && "nearest" !== e2.interpolation) throw new s("imagery-tile-mixin:get-samples", "only nearest interpolation is currently supported");
    ...
    async _initJobHandler() {
      if (!this._rasterJobHandler) return super._initJobHandler().then((async () => {
        ...
        e2.rasterJobHandler = this._rasterJobHandler, r4(e2) && e2.syncJobHandler(), this.rasterFunction && await this.updateRasterFunction().catch((() => {
    ...
    async _getSampleLocations(e2) {
      ...
      if ("polyline" === r6) {
        ...
        if (e2.sampleCount || e2.sampleDistance) {
          const i7 = await import("./densifyOperator-ABEDVICC.js"), s4 = (await import("./lengthOperator-KYGCW7HL.js")).execute(t2, { unit: "meters" }), n3 = Math.min(e2.sampleCount || 100, Q3);
...
//# sourceMappingURL=chunk-LT3FM7DL.js.map
