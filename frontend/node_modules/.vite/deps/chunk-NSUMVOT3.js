...
async function E(e, t, r2, s3) {
  ...
  const { edits: i2, options: n } = await S(e, r2, s3);
...
async function S(e, t, r2) {
  ...
  u.addFeatures.forEach(((t2) => O2(t2, e, p3, c2))), u.updateFeatures.forEach(((t2) => k(t2, e, p3, c2))), u.deleteFeatures.forEach(((t2) => U(t2, e, p3, c2))), u.addAttachments.forEach(((t2) => L2(t2, e))), u.updateAttachments.forEach(((t2) => L2(t2, e))), l && await x(u, e);
  return { edits: await B(u), options: d2 };
}
...
async function B(e) {
  const t = e.addFeatures ?? [], a2 = e.updateFeatures ?? [], r2 = t.concat(a2).map(((e2) => e2.geometry)), s3 = await R(r2), i2 = t.length, n = a2.length;
...
//# sourceMappingURL=chunk-NSUMVOT3.js.map
