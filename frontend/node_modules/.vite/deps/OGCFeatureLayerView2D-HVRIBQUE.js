...
import "./chunk-NXWY3CJ5.js";
import "./chunk-6AP7L3UM.js";
import "./chunk-PGNIZQW2.js";
import "./chunk-QHD5R6KE.js";
import "./chunk-F2L4YQPV.js";
import "./chunk-CNCYMTDM.js";
...
var o = (o2) => {
  let t2 = class extends o2 {
    get availableFields() {
      return this.layer.fieldsIndex.fields.map(((e) => e.name));
    }
  };
  return r([m()], t2.prototype, "layer", void 0), r([m({ readOnly: true })], t2.prototype, "availableFields", null), t2 = r([a("esri.views.layers.OGCFeatureLayerView")], t2), t2;
};

// node_modules/@arcgis/core/views/2d/layers/OGCFeatureLayerView2D.js
var t = class extends o(ce) {
  supportsSpatialReference(r2) {
    return this.layer.serviceSupportsSpatialReference(r2);
  }
};
t = r([a("esri.views.2d.layers.OGCFeatureLayerView2D")], t);
var a2 = t;
export {
  a2 as default
};
//# sourceMappingURL=OGCFeatureLayerView2D-HVRIBQUE.js.map
