  ...
  return l3.forEach(((e3, t3) => {
    ...
    switch (e3.type) {
      ...
      case "path": {
        ...
        if ("quad" === e3.profile) {
          const t5 = e3.width, n4 = e3.height, r2 = m(t5 && n4 ? t5 / n4 : 1, 0 === n4, 0 === t5), o3 = { ...i3, join: "bevel" };
      ...
      switch (e3.type) {
        case "fill": {
          ...
          if (c2 = Math.max(c2, a2), p2 = Math.max(p2, a2), u3 = true, l3) {
            ...
            null != a3 && "style" === a3.type && "solid" !== a3.style && n4 && (l4 = await H(a3, n4)), t3.push({ shape: e.fill[0], fill: l4, stroke: s4 });
          }
          break;
        }
        case "line": {
        ...
        case "extrude": {
          const l4 = { join: "round", width: 1, ...W(e3, -0.4) }, a2 = Z(e3, 0), s4 = Z(e3, -0.2), n4 = Math.min(o2, r || D), i3 = c(n4);
...
//# sourceMappingURL=chunk-EMQWPEYG.js.map
