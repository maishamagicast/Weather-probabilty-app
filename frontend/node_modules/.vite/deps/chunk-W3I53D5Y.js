import {
  u
} from "./chunk-LCT65JMM.js";
import {
  a as a3
} from "./chunk-IR6JOM7Y.js";
import {
  l as l2
...
var a7 = n = class extends c2 {
  ...
  clone() {
    return new n({ ...this.cloneProperties(), field: this.field, fieldTransformType: this.fieldTransformType, colorClassBreakInfos: a(this.colorClassBreakInfos), legendOptions: a(this.legendOptions) });
  }
};
...
var d = l5 = class extends c2 {
  ...
  clone() {
    return new l5({ ...this.cloneProperties(), field: a(this.field), fieldTransformType: a(this.fieldTransformType), stops: a(this.stops), legendOptions: a(this.legendOptions) });
  }
};
...
var u4 = l7 = class extends c2 {
  ...
  clone() {
    return new l7({ ...this.cloneProperties(), field: a(this.field), fieldTransformType: a(this.fieldTransformType), colorUniqueValueInfos: a(this.colorUniqueValueInfos), legendOptions: a(this.legendOptions) });
  }
};
...
//# sourceMappingURL=chunk-W3I53D5Y.js.map
