...
var s = class extends hi {
  setupDefaultRules() {
    ...
    u("InterfaceColors").setAll({ stroke: Yt.fromHex(15066597), fill: Yt.fromHex(15987699), primaryButton: Yt.fromHex(6788316), primaryButtonHover: Yt.fromHex(6779356), primaryButtonDown: Yt.fromHex(6872182), primaryButtonActive: Yt.fromHex(6872182), primaryButtonDisabled: Yt.fromHex(14342874), primaryButtonTextDisabled: Yt.fromHex(16777215), primaryButtonText: Yt.fromHex(16777215), primaryButtonStroke: Yt.fromHex(16777215), secondaryButton: Yt.fromHex(14277081), secondaryButtonHover: Yt.fromHex(10724259), secondaryButtonDown: Yt.fromHex(9276813), secondaryButtonActive: Yt.fromHex(15132390), secondaryButtonText: Yt.fromHex(0), secondaryButtonStroke: Yt.fromHex(16777215), grid: Yt.fromHex(0), background: Yt.fromHex(16777215), alternativeBackground: Yt.fromHex(0), text: Yt.fromHex(0), alternativeText: Yt.fromHex(16777215), disabled: Yt.fromHex(11382189), positive: Yt.fromHex(5288704), negative: Yt.fromHex(11730944) });
    {
      const e2 = u("ColorSet");
      e2.setAll({ passOptions: { hue: 0.05, saturation: 0, lightness: 0 }, colors: [Yt.fromHex(6797276)], step: 1, reuse: false, startIndex: 0 }), e2.setPrivate("currentStep", 0), e2.setPrivate("currentPass", 0);
    }
    u("Entity").setAll({ stateAnimationDuration: 0, stateAnimationEasing: Pe(we) }), u("Component").setAll({ interpolationDuration: 0, interpolationEasing: Pe(we) }), u("Sprite").setAll({ visible: true, scale: 1, opacity: 1, rotation: 0, position: "relative", tooltipX: a, tooltipY: a, tooltipPosition: "fixed", isMeasured: true }), u("Sprite").states.create("default", { visible: true, opacity: 1 }), u("Container").setAll({ interactiveChildren: true, setStateOnChildren: false }), u("Graphics").setAll({ strokeWidth: 1 }), u("Chart").setAll({ width: r, height: r, interactiveChildren: false }), u("ZoomableContainer").setAll({ width: r, height: r, wheelable: true, pinchZoom: true, maxZoomLevel: 32, minZoomLevel: 1, zoomStep: 2, animationEasing: Pe(we), animationDuration: 600, maxPanOut: 0.4 }), u("Sprite", ["horizontal", "center"]).setAll({ centerX: a, x: a }), u("Sprite", ["vertical", "center"]).setAll({ centerY: a, y: a }), u("Container", ["horizontal", "layout"]).setAll({ layout: d }), u("Container", ["vertical", "layout"]).setAll({ layout: c }), u("Pattern").setAll({ repetition: "repeat", width: 50, height: 50, rotation: 0, fillOpacity: 1 }), u("LinePattern").setAll({ gap: 6, colorOpacity: 1, width: 49, height: 49 }), u("RectanglePattern").setAll({ gap: 6, checkered: false, centered: true, maxWidth: 5, maxHeight: 5, width: 48, height: 48, strokeWidth: 0 }), u("CirclePattern").setAll({ gap: 5, checkered: false, centered: false, radius: 3, strokeWidth: 0, width: 45, height: 45 }), u("GrainPattern").setAll({ width: 200, height: 200, colors: [Yt.fromHex(0)], size: 1, horizontalGap: 0, verticalGap: 0, density: 1, minOpacity: 0, maxOpacity: 0.2 });
    {
      const e2 = u("PatternSet");
      e2.setAll({ step: 1 }), l(e2, "color", s2, "stroke");
    }
    u("LinearGradient").setAll({ rotation: 90 }), u("Legend").setAll({ fillField: "fill", strokeField: "stroke", nameField: "name", layout: Qe.new(this._root, {}), layer: 30, clickTarget: "itemContainer" }), u("Container", ["legend", "item", "itemcontainer"]).setAll({ paddingLeft: 5, paddingRight: 5, paddingBottom: 5, paddingTop: 5, layout: d, setStateOnChildren: true, interactiveChildren: false, ariaChecked: true, focusable: true, ariaLabel: e.translate("Press ENTER to toggle"), role: "checkbox" });
    {
    ...
    u("RadialLabel").setAll({ textType: "regular", centerY: a, centerX: a, inside: false, radius: 0, baseRadius: r, orientation: "auto", textAlign: "center" }), u("EditableLabel").setAll({ editOn: "click", themeTags: ["editablelabel"], multiLine: true }), u("RoundedRectangle", ["editablelabel", "background"]).setAll({ fillOpacity: 0, fill: Yt.fromHex(0), cornerRadiusBL: 3, cornerRadiusBR: 3, cornerRadiusTL: 3, cornerRadiusTR: 3, strokeOpacity: 0, stroke: Yt.fromHex(0) }), u("RoundedRectangle", ["editablelabel", "background"]).states.create("active", { strokeOpacity: 0.2 }), u("RoundedRectangle").setAll({ cornerRadiusTL: 8, cornerRadiusBL: 8, cornerRadiusTR: 8, cornerRadiusBR: 8 }), u("PointedRectangle").setAll({ pointerBaseWidth: 15, pointerLength: 10, cornerRadius: 8 }), u("Slice").setAll({ shiftRadius: 0, dRadius: 0, dInnerRadius: 0 });
    {
      const e2 = u("Tick");
      e2.setAll({ strokeOpacity: 0.15, isMeasured: false, length: 4.5, position: "absolute", crisp: true }), l(e2, "stroke", s2, "grid");
    }
    u("Bullet").setAll({ locationX: 0.5, locationY: 0.5 }), u("Tooltip").setAll({ position: "absolute", getFillFromSprite: true, getStrokeFromSprite: false, autoTextColor: true, paddingTop: 9, paddingBottom: 8, paddingLeft: 10, paddingRight: 10, marginBottom: 5, pointerOrientation: "vertical", centerX: a, centerY: a, animationEasing: Pe(we), exportable: false }), u("Polygon").setAll({ animationEasing: Pe(we) });
    u("PointedRectangle", ["tooltip", "background"]).setAll({ strokeOpacity: 0.9, cornerRadius: 4, pointerLength: 4, pointerBaseWidth: 8, fillOpacity: 0.9, stroke: Yt.fromHex(16777215) });
    {
    ...
    u("Button").setAll({ paddingTop: 8, paddingBottom: 8, paddingLeft: 10, paddingRight: 10, interactive: true, layout: d, interactiveChildren: false, setStateOnChildren: true, focusable: true }), u("Button").states.create("hover", {}), u("Button").states.create("down", { stateAnimationDuration: 0 }), u("Button").states.create("active", {}), u("Button").states.create("disabled", { forceInactive: true });
    {
    ...
    l(u("RoundedRectangle", ["button", "background"]).states.create("disabled", {}), "fill", s2, "primaryButtonDisabled");
    l(u("Graphics", ["button", "icon"]).states.create("disabled", {}), "fill", s2, "primaryButtonTextDisabled");
    l(u("Label", ["button"]).states.create("disabled", {}), "fill", s2, "primaryButtonTextDisabled");
    {
      const e2 = u("Graphics", ["button", "icon"]);
      e2.setAll({ forceInactive: true }), l(e2, "stroke", s2, "primaryButtonText");
    }
    ...
    u("Graphics", ["switch", "icon"]).states.create("active", { dx: 16 }), u("Scrollbar").setAll({ start: 0, end: 1, layer: 30, animationEasing: Pe(we) }), u("Scrollbar", ["vertical"]).setAll({ marginRight: 13, marginLeft: 13, minWidth: 12, height: r }), u("Scrollbar", ["horizontal"]).setAll({ marginTop: 13, marginBottom: 13, minHeight: 12, width: r }), this.rule("Button", ["scrollbar"]).setAll({ exportable: false });
    {
...
//# sourceMappingURL=chunk-FJDQ2XWG.js.map
