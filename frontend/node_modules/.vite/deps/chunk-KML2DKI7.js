...
import {
  v
} from "./chunk-VP22BRUV.js";
import {
  A as A3
} from "./chunk-Z6FTTTCT.js";
import {
  A as A2,
  I
} from "./chunk-AL2RVMAM.js";
import {
  c,
  i as i4,
  o as o2,
...
var G2 = class extends p {
  ...
  async uploadAssets(e2, t3) {
    const { uploadAssets: s5 } = await import("./uploadAssets-WPDQP3U2.js");
  ...
  async _uploadMeshesAndGetAssetMapEditsJSON(e2) {
    ...
    for (const i5 of t3) {
      ...
      if (t(t4)) r3.push(e3);
        ...
        const t5 = e3.origin, { convertMeshVertexSpace: s6 } = await import("./convertMeshVertexSpace-5ITFNW5V.js"), n = await s6(e3, new i2({ origin: [t5.x, t5.y, t5.z ?? 0] }));
...
//# sourceMappingURL=chunk-KML2DKI7.js.map
