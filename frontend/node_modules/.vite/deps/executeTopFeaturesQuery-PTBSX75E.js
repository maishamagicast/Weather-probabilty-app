import {
  p
} from "./chunk-5PYVKFY7.js";
import {
  j
} from "./chunk-SR3ZD3FR.js";
import {
  g
...
async function s(s2, p2, u, a) {
  const m = f(s2), i = { ...a }, { data: f2 } = await p(m, j.from(p2), u, i);
  return g.fromJSON(f2);
}
export {
  s as executeTopFeaturesQuery
};
//# sourceMappingURL=executeTopFeaturesQuery-PTBSX75E.js.map
