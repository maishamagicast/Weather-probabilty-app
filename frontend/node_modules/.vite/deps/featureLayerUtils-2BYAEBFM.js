...
async function H(e) {
  ...
  e.forEach((({ type: e2 }) => {
    switch (l(e2)) {
      case "CatalogLayer":
        r.push(import("./CatalogLayer-SQDOTXQW.js").then(((e3) => e3.default)));
        break;
      case "FeatureLayer":
        r.push(import("./FeatureLayer-JYTIQYGO.js").then(((e3) => e3.default)));
        break;
      case "OrientedImageryLayer":
        r.push(import("./OrientedImageryLayer-2UPZCPVI.js").then(((e3) => e3.default)));
    }
  }));
...
//# sourceMappingURL=featureLayerUtils-2BYAEBFM.js.map
