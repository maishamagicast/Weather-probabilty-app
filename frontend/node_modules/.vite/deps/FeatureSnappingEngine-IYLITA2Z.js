...
function u3(s5, a3, d5) {
  const l4 = new V(), u4 = c3(s5, ((t) => d2((async (e2) => {
...
var P = class extends b {
  ...
  _loadSourceModule(e2) {
    ...
    switch (e2) {
      case "featureService":
        return t.addPromise(import("./FeatureServiceSnappingSource-MIWC4GZZ.js"));
      case "featureCollection":
        return t.addPromise(import("./FeatureCollectionSnappingSource-RBB2WO6R.js"));
      case "graphics":
      case "notes":
        return t.addPromise(import("./GraphicsSnappingSource-OTZRP63K.js"));
      case "scene":
        return t.addPromise(import("./SceneLayerSnappingSource-TKQLS3NE.js"));
    }
  }
  get test() {
  }
...
//# sourceMappingURL=FeatureSnappingEngine-IYLITA2Z.js.map
