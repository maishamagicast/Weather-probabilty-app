...
var o = class extends ce {
  initialize() {
    this.addHandles([l((() => this.view.scale), (() => this._update()), h)], "constructor");
  }
  isUpdating() {
    const e = this.layer.sublayers.some(((e2) => null != e2.renderer)), r2 = this._commandsQueue.updateTracking.updating, s = null != this._updatingRequiredPromise, i = !this._workerProxy, t = this.dataUpdating, o2 = e && (r2 || s || i || t);
...
o = r([a("esri.views.2d.layers.SubtypeGroupLayerView2D")], o);
var a2 = o;
export {
  a2 as default
};
//# sourceMappingURL=SubtypeGroupLayerView2D-FZOESCBX.js.map
