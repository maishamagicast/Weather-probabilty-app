...
function o(h2, i2) {
  ...
  return { format: d2, quality: r(null != o2 ? o2 : u2, 0, 100), area: l2, width: g2, height: f2, rotation: n2, disableDecorations: !!a2, ignoreBackground: !!h2?.ignoreBackground, ignorePadding: !!h2?.ignorePadding };
}
function n(t, h2) {
  const i2 = o(t, h2), e2 = i2.area, n2 = i2.width / e2.width, a2 = b(i2, h2.padding), r3 = a2.left + a2.right, l2 = a2.top + a2.bottom, g2 = h2.width - r3, f2 = h2.height - l2, d2 = Math.floor(g2 * n2 + r3), u2 = Math.floor(f2 * n2 + l2), c2 = t?.layers ?? [], s3 = i2.ignoreBackground, w2 = i2.ignorePadding;
...
function y(t, h2) {
  if (null == h2?.width || null == h2.height) return t;
...
function b(t, h2) {
  return !h2 || t?.ignorePadding ? k : h2;
}
function j(t) {
  switch (t) {
    case "png":
...
//# sourceMappingURL=chunk-5VQNXWSJ.js.map
