...
var j = false;
async function v() {
  return N || (N = L2(), E = await import("./projectOperator-G64GXTTJ.js"), T = await import("./geographicTransformationUtils-RH2FPKXM.js"), E.isLoaded() || await E.load(), T.isLoaded() || await T.load(), j = true, N.resolve()), N.promise;
}
function C(e, t, n) {
  if (g(), n) {
...
function se(e) {
  ...
  if (t && (r || a2 > R) && (l.isGeographic || J(l), n = [M, M], o = ae({ ...e, spacing: n }), i = { cols: o.size[0] + 1, rows: o.size[1] + 1 }, s3 = y(o.offsets, i, n, R)), o.error = s3, n[0] > 1 && (o.coefficients = le(o.offsets, i, r)), e.includeGCSGrid && !l.isGeographic && !l.isWebMercator) if (c.isGeographic) o.gcsGrid = { offsets: o.offsets, coefficients: o.coefficients, spacing: n };
  else {
    const t2 = J(l);
    if (null != t2 && !t2.isEnvelope) {
      const t3 = re(l), s4 = Q(e.projectedExtent, t3), { offsets: a3 } = ae({ ...e, srcBufferExtent: s4, spacing: n }), c2 = le(a3, i, r);
...
//# sourceMappingURL=chunk-JA3W3C47.js.map
