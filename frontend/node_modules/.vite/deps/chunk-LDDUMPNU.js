...
import {
  ...
  w as w3,
  y as y3
} from "./chunk-PXNA3G6N.js";
import {
  t as t2
} from "./chunk-OUR2XGMQ.js";
import {
  m as m3,
  m2 as m4,
  m3 as m5,
...
var O = class {
  ...
  async createQueryResponse() {
    ...
    if (this.query.returnQueryGeometry) {
      ...
      N(this.query.outSR) && !s3(t6.spatialReference, this.query.outSR) ? e5.queryGeometry = h({ spatialReference: this.query.outSR, ...j(t6, t6.spatialReference, this.query.outSR) }) : e5.queryGeometry = h({ spatialReference: this.query.outSR, ...t6 });
    }
    return e5;
  }
  ...
  async _createAutoIntervalBinsResponse(e5, t6, i2) {
    const { field: s8, normalizationField: a5, numBins: r5, normalizationType: n5, normalizationTotal: o2, start: l7, end: u6 } = e5, c4 = await this._getDataValues({ field: e5.field, normalizationField: e5.normalizationField, normalizationType: e5.normalizationType, normalizationTotal: e5.normalizationTotal, timeZone: t6.outTimeReference?.ianaTimeZone }, i2), m8 = G(c4, { field: s8, normalizationField: a5, normalizationType: n5, normalizationTotal: o2, numBins: r5, minValue: h2(l7, false), maxValue: h2(u6, false) }), d5 = await this._calculateHistogramBins(c4, m8, i2);
    return this._createFeaturesFromHistogramBins(d5, t6);
  }
  async _createDateBinsResponse(e5, t6, i2) {
    const { field: s8, interval: a5, start: r5, end: n5, snapToData: o2, returnFullIntervalBin: l7 } = e5, u6 = a5.unit, c4 = await this._getDataValues({ field: e5.field, timeZone: t6.outTimeReference?.ianaTimeZone }, i2), m8 = Te(this.fieldsIndex.get(s8)), d5 = s5.toJSON(u6), h4 = c4.filter(Boolean).sort(((e6, t7) => e6 - t7)), p4 = null != r5 ? h2(r5, m8) : h4[0], y6 = null != n5 ? h2(n5, m8) : h4[h4.length - 1], g3 = { zone: t6.outTimeReference?.ianaTimeZone ?? n }, x3 = DateTime.fromMillis(p4, g3), T2 = DateTime.fromMillis(y6, g3), F2 = [];
    if ("last" === o2) {
      let e6 = T2;
      for (; e6 > x3; ) {
  ...
  async _createFixedBoundariesBinsResponse(e5, t6, i2) {
    const { field: s8 } = e5, a5 = await this._getDataValues({ field: s8, timeZone: t6.outTimeReference?.ianaTimeZone }, i2), r5 = Te(this.fieldsIndex.get(s8)), n5 = e5.boundaries.map(((e6) => h2(e6, r5))).sort(((e6, t7) => e6 - t7)), o2 = [];
  ...
  async _executeSceneFilterQuery(e5, t6) {
    ...
    if ("disjoint" === e5.sceneFilter.spatialRelationship) {
      ...
      const i3 = await this.reschedule((() => this._getAllFeatures()), t6), r6 = await this.reschedule((async () => {
        const r7 = await I2("esriSpatialRelDisjoint", u6, this.geometryType, this.hasZ, this.hasM), a6 = (e6) => !s9.has(h4.getObjectId(e6)) || r7(h4.getGeometry(e6)), n6 = await this.runSpatialFilter(i3, a6, t6);
    ...
    const m8 = await I2("esriSpatialRelContains", u6, this.geometryType, this.hasZ, this.hasM), f4 = await this.runSpatialFilter(c4, ((e6) => m8(h4.getGeometry(e6))), t6);
  ...
  async _executeGeometryQuery(s8, i2, r5) {
    ...
    if ("esriSpatialRelDisjoint" === x3) {
      ...
      const t6 = null != i2 ? i2.items : await this.reschedule((() => this._getAllFeatures()), r5), a6 = await this.reschedule((async () => {
        const i3 = await I2(x3, y6, this.geometryType, this.hasZ, this.hasM), a7 = (t7) => !e5.has(p4.getObjectId(t7)) || i3(p4.getGeometry(t7)), n6 = await this.runSpatialFilter(t6, a7, r5);
    ...
    const w4 = await I2(x3, y6, this.geometryType, this.hasZ, this.hasM), F2 = await this.runSpatialFilter(g3, ((e5) => w4(p4.getGeometry(e5))), r5);
...
//# sourceMappingURL=chunk-LDDUMPNU.js.map
