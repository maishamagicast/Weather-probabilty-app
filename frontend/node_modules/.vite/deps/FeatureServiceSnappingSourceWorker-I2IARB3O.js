...
var j3 = class extends b {
  ...
  async handleEdits(e3) {
    ...
    const t3 = { ...e3, deletedFeatures: e3.deletedFeatures.map((({ objectId: e4, globalId: t4 }) => e4 && -1 !== e4 ? e4 : this._lookupObjectIdByGlobalId(t4))) }, i5 = d((async (e4) => {
      try {
        ...
        a(i6), i.getLogger(this).warn("Failed to apply edits", i6);
      }
    }));
  ...
  _initializeFetchExtent() {
    ...
    const e3 = d((async (e4) => {
      try {
        ...
        a(t3), i.getLogger(this).warn("Failed to fetch data extent", t3);
      }
    }));
  ...
  async _queryFeaturesPBF(e3, t3) {
    const { sourceSpatialReference: i5 } = this, { data: s2 } = await f6(this.url, e3, new a3({ sourceSpatialReference: i5 }), { query: this._configuration.customParameters, timeout: x, signal: t3 });
    return ht(s2);
  }
  async _queryFeaturesJSON(e3, t3) {
    const { sourceSpatialReference: i5 } = this, { data: s2 } = await c2(this.url, e3, i5, { query: this._configuration.customParameters, timeout: x, signal: t3 });
...
r([m({ constructOnly: true })], g2.prototype, "featureStore", void 0), r([m()], g2.prototype, "tileInfo", void 0), r([m()], g2.prototype, "extent", void 0), r([m()], g2.prototype, "maximumByteSize", void 0), g2 = r([a2("esri.views.interactive.snapping.featureSources.featureServiceSource.FeatureServiceTileStore")], g2);
var v = class {
...
r([m({ readOnly: true })], w3.prototype, "updating", null), r([m()], w3.prototype, "_isInitializing", void 0), w3 = r([a2("esri.views.interactive.snapping.featureSources.featureServiceSource.FeatureServiceSnappingSourceWorker")], w3);
var j4 = w3;
function b3(e3, t3) {
  const i5 = !!t3 || void 0;
...
//# sourceMappingURL=FeatureServiceSnappingSourceWorker-I2IARB3O.js.map
