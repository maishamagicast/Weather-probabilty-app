...
async function a3(a4, m2, e) {
  const i2 = f(a4), s4 = await O(i2, R2.from(m2), { ...e }), u = s4.data.extent;
...
var S = class extends b {
  ...
  async executeJSON(e, t) {
    ...
    if (this.pbfSupported && i2) try {
      u = await n(this.url, r2, t, { uniqueIdFields: this.uniqueIdFields });
    } catch (n2) {
      if ("query:parsing-pbf" !== n2.name) throw n2;
      this.pbfSupported = false;
    }
    return this.pbfSupported && i2 || (u = await a2(this.url, r2, t, { uniqueIdFields: this.uniqueIdFields })), this._normalizeFields(u.fields), u;
  }
  async featureSetFromJSON(e, t, r2) {
    if (!this._queryIs3DObjectFormat(e) || null == this.infoFor3D || !t.features) return g.fromJSON(t);
    const { meshFeatureSetFromJSON: s4 } = await h(import("./meshFeatureSet-W4NBCA22.js"), r2);
  ...
  async executeRelationshipQuery(e, t) {
    const [{ default: r2 }, { executeRelationshipQuery: s4 }] = await h(Promise.all([import("./RelationshipQuery-NMKYXCTR.js"), import("./executeRelationshipQuery-6QPNWNOK.js")]), t);
  ...
  async executeRelationshipQueryForCount(e, t) {
    const [{ default: r2 }, { executeRelationshipQueryForCount: s4 }] = await h(Promise.all([import("./RelationshipQuery-NMKYXCTR.js"), import("./executeRelationshipQuery-6QPNWNOK.js")]), t);
    return e = r2.from(e), (this.gdbVersion || this.dynamicDataSource) && ((e = e.clone()).gdbVersion = e.gdbVersion || this.gdbVersion, e.dynamicDataSource = e.dynamicDataSource || this.dynamicDataSource), s4(this.url, e, t);
  }
  async executeAttachmentQuery(e, t) {
    const { executeAttachmentQuery: r2, fetchAttachments: s4, processAttachmentQueryResult: i2 } = await h(import("./queryAttachments-MZV7YX6Y.js"), t), u = f(this.url);
    return i2(u, await (this.queryAttachmentsSupported ? r2(u, e, t) : s4(u, e, t)));
  }
  async executeAttributeBinsQuery(e, t) {
    const { executeAttributeBinsQuery: r2 } = await h(import("./executeAttributeBinsQuery-ILFWG3R7.js"), t);
    return r2(this.parsedUrl, e, t);
  }
  async executeTopFeaturesQuery(e, t) {
    const { executeTopFeaturesQuery: r2 } = await h(import("./executeTopFeaturesQuery-PTBSX75E.js"), t);
    return r2(this.parsedUrl, e, this.sourceSpatialReference, t);
  }
  async executeForTopIds(e, t) {
    const { executeForTopIds: r2 } = await h(import("./executeForTopIds-M4E7PSWB.js"), t);
    return r2(this.parsedUrl, e, t);
  }
  async executeForTopExtents(e, t) {
    const { executeForTopExtents: r2 } = await h(import("./executeForTopExtents-65NOK2LS.js"), t);
    return r2(this.parsedUrl, e, t);
  }
  async executeForTopCount(e, t) {
    const { executeForTopCount: r2 } = await h(import("./executeForTopCount-JACUF7CY.js"), t);
    return r2(this.parsedUrl, e, t);
  }
  _normalizeQuery(e) {
    let t = R2.from(e);
...
//# sourceMappingURL=chunk-25VP2OQW.js.map
