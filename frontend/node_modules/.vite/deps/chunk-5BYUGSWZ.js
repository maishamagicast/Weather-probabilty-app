...
var b = { ...w, json: { ...w.json, origins: { "web-document": { ...f2, write: { enabled: true, layerContainerTypes: a3, target: { opacity: { type: Number }, "layerDefinition.drawingInfo.transparency": { type: Number } } } } }, read: { source: ["layerDefinition.drawingInfo.transparency", "drawingInfo.transparency"], reader: (e2, r5, n3) => n3 && "service" !== n3.origin || !r5.drawingInfo || void 0 === r5.drawingInfo.transparency ? r5.layerDefinition?.drawingInfo && void 0 !== r5.layerDefinition.drawingInfo.transparency ? r3(r5.layerDefinition.drawingInfo.transparency) : void 0 : r3(r5.drawingInfo.transparency) } } };
...
//# sourceMappingURL=chunk-5BYUGSWZ.js.map
