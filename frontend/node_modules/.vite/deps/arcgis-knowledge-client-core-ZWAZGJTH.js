...
function n() {
  return t || (t = 1, r = a, n2 = "undefined" != typeof document ? document.currentScript?.src : void 0, i2 = function(r2 = {}) {
    ...
    !(async function() {
      ...
      R ??= U("arcgis-knowledge-client-core.wasm") ? "arcgis-knowledge-client-core.wasm" : o3.locateFile ? o3.locateFile("arcgis-knowledge-client-core.wasm", l) : l + "arcgis-knowledge-client-core.wasm";
      try {
        var t3 = await H(r3);
...
//# sourceMappingURL=arcgis-knowledge-client-core-ZWAZGJTH.js.map
