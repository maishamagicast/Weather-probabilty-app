...
import {
  ...
  j as j4,
  w
} from "./chunk-OTD22OSX.js";
import {
  s as s4
} from "./chunk-AP7A45V5.js";
import {
  o as o5
} from "./chunk-IE6QJMDY.js";
import {
  b as b2,
  j as j3,
  n as n6
...
function y4(e7) {
  ...
  return new s6({ name: "direction", actual: U, parse: B({ createQuantity: (t9, e8) => o4(t9, a8(e8), "geographic"), sanitize: C }), format: (t9, e8) => {
...
function U3(t9) {
  ...
  return new s6({ name: "distance", actual: h3, parse: B({ createQuantity: (t10, a8) => a4(Math.max(t10, 0), e7(a8)) }), format: (t10, e8) => e8.formatters.length(t10), formatForInputMode: (t10, a8) => a8.formatters.scalar(s3(t10, e7(a8))), suffix: (t10) => t10.inputUnitInfos.length.abbreviation, title: (t10) => t10.messages.sketch.distance, ...t9 });
}
function w4(t9) {
...
function R2(t9) {
  return B2("scale", { name: "scale", actual: null, parse: B({ createQuantity: (t10) => i2(Math.abs(t10)) }), ...t9 });
}
function Q(t9) {
  const e7 = (t10) => t10.inputUnitInfos.area.unit;
  return new s6({ name: "area", actual: d2, parse: B({ createQuantity: (t10, a8) => l3(t10, e7(a8)) }), format: (t10, e8) => e8.formatters.area(t10), formatForInputMode: (t10, a8) => a8.formatters.scalar(s3(t10, e7(a8))), suffix: (t10) => t10.inputUnitInfos.area.abbreviation, title: (t10) => t10.messages.sketch.area, readOnly: true, ...t9 });
}
function D(e7) {
  return new s6({ name: "x", actual: U, parse: H2, format: (t9, e8) => e8.formatters.longitudeDecimalDegrees(t9), formatForInputMode: (t9) => w2(t9), suffix: (t9) => t9.inputUnitInfos.angle.abbreviation, title: (t9) => t9.messages.sketch.longitude, ...e7 });
}
function O2(e7) {
  return new s6({ name: "y", actual: U, parse: J2, format: (t9, e8) => e8.formatters.latitudeDecimalDegrees(t9), formatForInputMode: (t9) => A3(t9), suffix: (t9) => t9.inputUnitInfos.angle.abbreviation, title: (t9) => t9.messages.sketch.latitude, ...e7 });
}
function T2(t9) {
...
function B2(t9, a8) {
  return new s6({ actual: i2(0), parse: B({ createQuantity: (t10) => i2(t10) }), format: (t10, e7) => e7.formatters.scalar(t10), formatForInputMode: (t10, e7) => e7.formatters.scalar(t10), title: (e7) => e7.messages.sketch[t9], ...a8 });
}
...
//# sourceMappingURL=chunk-OGSQVCBG.js.map
