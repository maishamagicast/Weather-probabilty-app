...
async function o(e, t = {}, s2) {
  await e.load(s2);
  const o2 = V(e.itemUrl, "resources"), { start: a2 = 1, num: n2 = 10, sortOrder: c2 = "asc", sortField: l2 = "resource" } = t, i2 = { query: { start: a2, num: n2, sortOrder: c2, sortField: l2, token: e.apiKey }, signal: s2?.signal }, u2 = await e.portal.request(o2, i2);
...
async function n(e, s2, o2) {
  ...
  await e.portal.request(a2, { method: "post", query: { resource: s2.path }, signal: o2?.signal }), s2.portalItem = null;
}
async function c(e, t) {
  await e.load(t);
  const s2 = V(e.userItemUrl, "removeResources");
  return e.portal.request(s2, { method: "post", query: { deleteAll: true }, signal: t?.signal });
}
function l(e) {
...
//# sourceMappingURL=chunk-RVLJR3ER.js.map
