...
async function i() {
  if (!o()) {
    const [n2, o2] = await Promise.all([import("./OperatorGeodeticArea-VEULD257.js"), import("./ProjectionTransformation-RMC77OPG.js").then(((e2) => e2.aG)).then((({ injectPe: e2 }) => e2)), _()]);
...
//# sourceMappingURL=chunk-M2ADMM3Y.js.map
