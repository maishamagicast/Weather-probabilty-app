...
var o6 = class {
  constructor(t10, s9) {
    ...
    for (const e10 of s9.groups) this.groups.push({ ...e10, vertexArrays: /* @__PURE__ */ new Map() });
    this.parts = s9.parts;
  }
  bind(e10, r7, s9) {
    this._boundPart = s9;
...
function K4(i11, t10, o14) {
  ...
  return i11 = i11.add(s9), It({ animationPointer: i11, ...o14 }, Y2, null, ((i12) => {
    const { out: t11 } = i12;
    if (!t11) throw new Error("out is null");
    return g({ ...i12, out: t11 });
  }));
}
...
var x = class extends B5 {
  ...
  vertex(t10, o14) {
    ...
    return { glPosition: new Y2(i11.xy, p14, 1), color: e10, ...this.maybeRunHittest(t10, o14, null) };
  }
  fragment(t10) {
...
var _5 = class extends x {
  ...
  vertex(t10, e10) {
    return { ...super.vertex(t10, e10), ...P5(this, t10) };
  }
  fragment(t10) {
...
var _6 = class extends B5 {
  ...
  vertex(t10, i11) {
    ...
    return { ...e10, ...this.maybeRunHittest(t10, i11, e10.halfWidth) };
  }
  fragment(t10) {
...
var q8 = class extends J2 {
  ...
  _hittestMarker(t10, e10, i11) {
    const s9 = this._vertexPreamble({ ...t10 }, t10.angle, new _3(0)).position, o14 = this._vertexPreamble({ ...t10, offset: e10.offsetNextVertex1 }, t10.angle, new _3(0)).position, l10 = this._vertexPreamble({ ...t10, offset: e10.offsetNextVertex2 }, t10.angle, new _3(0)).position, a8 = this.hittestRequest.position, n15 = this.hittestRequest.distance, d10 = P4(a8, s9, o14, l10);
...
var l4 = class extends t8 {
  render(r7, l10) {
    ...
    f15.setShader({ shader: this.shaders.geometry, uniforms: { ...m2(r7, l10.target, T5.uniforms), ...h2(r7, l10.target), mosaicInfo: y7, animationInfo: { globalTime: false === p14 ? r7.time / 1e3 : p14, animationTextureSize: [x7.descriptor.width, x7.descriptor.height], animationTexture: { unit: 6, texture: x7 }, toScreen: D7, toNdc: h11, mapRotation: r7.state.rotation, pixelRatio: r7.state.pixelRatio }, localTileOffset: w(l10.target) }, defines: { ...y(r7) }, optionalAttributes: { zoomRange: R9, value1Position2Value2: S9, accumulatedDistance: j6, segmentDirection: A8, normal: I5 }, useComputeBuffer: true }), f15.setPipelineState({ ...M3(r7) }), f15.submitDraw(r7, l10), false === p14 && g12.requestRender();
  }
};
...
var w4 = class extends t8 {
  ...
  _renderPolygons(e10, t10) {
    ...
    i11.setShader({ shader: this.shaders.fill, uniforms: { ...h2(e10, t10.target), visualVariableColor: null, visualVariableOpacity: null }, defines: { ...y(e10) }, optionalAttributes: { zoomRange: false }, useComputeBuffer: f(e10) }), i11.setPipelineState(M3(e10)), i11.submitDraw(e10, t10);
  }
  _renderDotDensity(o14, r7) {
    ...
    u11.setShader({ shader: this.shaders.polygon, uniforms: { ...h2(o14, r7.target), instance: { isActive: p14.isActive, colors: p14.colors, dotValue: Math.max(1, b10) }, draw: { dotTexture0: { unit: H2, texture: m17[0] }, dotTexture1: { unit: I, texture: m17[1] }, tileZoomFactor: w9, pixelRatio: window.devicePixelRatio, tileDotsOverArea: x7 / (a * window.devicePixelRatio * a * window.devicePixelRatio) } }, defines: { ...y(o14), blending: p14.blending }, optionalAttributes: {}, useComputeBuffer: false });
    ...
    const S9 = h11.getFBO(s9).colorTexture, _9 = { shader: this.shaders.point, uniforms: { view: c2(o14, r7.target), instance: { dotSize: p14.dotSize }, draw: { locations: { unit: H2, texture: S9 }, tileZoomFactor: 1, pixelRatio: window.devicePixelRatio } }, defines: { ...y(o14) }, optionalAttributes: {}, useComputeBuffer: false };
...
function H5(t10, o14, i11) {
  ...
  return { isOutline: s9, color: V4, opacity: new _3(1), halfWidth: c7, normal: d10.normal, glPosition: z7, ...M6 };
}
...
var T4 = class extends x {
  ...
  vertex(t10, e10) {
    return { ...super.vertex(t10, e10), ...O2(this, t10) };
  }
  fragment(t10) {
...
var x2 = class extends q9 {
  ...
  vertex(t10, r7) {
    return { ...H5(this, t10, r7), ...O2(this, t10) };
  }
  fragment(t10) {
...
var R7 = class extends k3 {
  ...
  vertex(t10, o14) {
    const { aux1: e10, aux2: r7, aux3: i11, aux4: p14 } = t10, a8 = { ...t10, width: e10, height: r7, offset: i11, scale: p14.multiply(b3) }, n15 = { ...t10, halfWidth: e10, referenceHalfWidth: r7, offset: i11, normal: p14.subtract(L5).multiply(b3) }, m17 = H5(this, n15), u11 = P5(this, a8), f15 = Gt(m17.isOutline, new _3(0.5));
    return { ...m17, ...u11, ...this.maybeRunHittest(t10, o14, f15) };
  }
  fragment(t10) {
...
var m7 = class extends t8 {
  ...
  render(e10, a8) {
    ...
    m17.setShader({ shader: this.shaders.geometry, uniforms: { ...m2(e10, a8.target, f15.uniforms), ...h2(e10, a8.target), antialiasingControls: n7(p14), mosaicInfo: m17.textureManager.getMosaicInfo(u11, a8.textureKey), localTileOffset: w(a8.target) }, defines: { ...y(e10) }, optionalAttributes: f15.optionalAttributes, useComputeBuffer: f(e10) }), m17.setPipelineState(M3(e10)), m17.submitDraw(e10, a8);
  }
};
...
var u4 = class extends t8 {
  ...
  render(e10, n15) {
    ...
    a8.setShader({ shader: this.shaders.geometry, uniforms: { ...m2(e10, n15.target, u11.uniforms), ...h2(e10, n15.target) }, defines: y(e10), optionalAttributes: u11.optionalAttributes, useComputeBuffer: f(e10) }), a8.setPipelineState(M3(e10)), a8.submitDraw(e10, n15);
  }
};
...
var A6 = class extends x {
  ...
  vertex(t10, e10) {
    ...
    return { ...super.vertex(t10, e10), tlbr: i11, relativePosition: r7, gradientMethod: o14, gradientSize: n15.multiply(d10), isDiscrete: v2(t10.bitset, e3.isDiscrete) };
  }
  fragment(t10) {
...
var u5 = class extends t8 {
  ...
  render(e10, t10) {
    ...
    m17.setShader({ shader: this.shaders.geometry, uniforms: { ...m2(e10, t10.target, u11.uniforms), ...h2(e10, t10.target), mosaicInfo: m17.textureManager.getMosaicInfo(a8, t10.textureKey) }, defines: { ...y(e10) }, optionalAttributes: u11.optionalAttributes, useComputeBuffer: f(e10) }), m17.setPipelineState(M3(e10)), m17.submitDraw(e10, t10);
  }
};
...
var l5 = class extends t8 {
  ...
  render(e10, n15) {
    ...
    u11.setShader({ shader: this.shaders.geometry, uniforms: { ...m2(e10, n15.target, m17.uniforms), ...h2(e10, n15.target), antialiasingControls: n7(l10) }, defines: { ...y(e10) }, optionalAttributes: m17.optionalAttributes, useComputeBuffer: f(e10) }), u11.setPipelineState(M3(e10)), u11.submitDraw(e10, n15);
  }
};
...
var m8 = class extends t8 {
  ...
  render(e10, n15) {
    ...
    m17.setShader({ shader: this.shaders.geometry, uniforms: { ...m2(e10, n15.target, f15.uniforms), ...h2(e10, n15.target), mosaicInfo: m17.textureManager.getMosaicInfo(u11, n15.textureKey), localTileOffset: w(n15.target) }, defines: { ...y(e10) }, optionalAttributes: f15.optionalAttributes, useComputeBuffer: f(e10) }), m17.setPipelineState(M3(e10)), m17.submitDraw(e10, n15);
  }
};
...
var m9 = class extends t8 {
  ...
  render(e10, a8) {
    ...
    m17.setShader({ shader: this.shaders.geometry, uniforms: { ...m2(e10, a8.target, f15.uniforms), ...h2(e10, a8.target), antialiasingControls: n7(p14), mosaicInfo: m17.textureManager.getMosaicInfo(l10, a8.textureKey), localTileOffset: w(a8.target) }, defines: { ...y(e10) }, optionalAttributes: f15.optionalAttributes, useComputeBuffer: f(e10) }), m17.setPipelineState(M3(e10)), m17.submitDraw(e10, a8);
  }
};
...
var f8 = class {
  ...
  loadQualityProfile(e10) {
    if (null == this._qualityProfile) {
      const r7 = n8(e10, m10());
      this._qualityProfile = { ...r7, defines: { usesHalfFloatPrecision: r7.dataType !== X.FLOAT } };
    }
...
var F6 = class extends B5 {
  ...
  vertex(t10) {
    ...
    return { glPosition: new Y2(o14.xy, r7, 1), offset: i11, fieldValue: l10, color: new Y2(0), ...this.maybeRunHittest(t10, {}, null) };
  }
  fragment(t10) {
...
var h8 = class extends t8 {
  ...
  render(e10, t10) {
    ...
    f(e10) || this._bind(e10, d10, a8), o14.setShader({ shader: this.shaders.accumulate, uniforms: { ...h2(e10, t10.target), kernelControls: { radius: b5(a8, u11), isFieldActive: l10 ? 1 : 0 } }, defines: { ...y(e10), ...c7.defines }, optionalAttributes: {}, useComputeBuffer: f(e10) });
...
var l7 = class extends t8 {
  ...
  render(e10, s9) {
    const { context: t10, painter: m17 } = e10, u11 = y(e10), l10 = { ...M3(e10), stencil: { write: false, test: { ref: () => 255, compare: C.GREATER, mask: 255, op: { fail: D.KEEP, zFail: D.KEEP, zPass: D.KEEP } } } }, c7 = s9.instance.getInput(), h11 = { shader: this.shaders.geometry, uniforms: { ...m2(e10, s9.target, c7.uniforms), ...h2(e10, s9.target), mosaicInfo: m17.textureManager.getMosaicInfo(t10, s9.textureKey) }, defines: { ...u11, textRenderPassType: K5.Color, isBackgroundPass: true, isLabel: true }, optionalAttributes: c7.optionalAttributes, useComputeBuffer: f(e10) };
    m17.setPipelineState(l10), m17.setShader(h11), m17.submitDraw(e10, s9), m17.setShader({ ...h11, defines: { ...u11, textRenderPassType: K5.Halo, isBackgroundPass: false, isLabel: true } }), m17.submitDraw(e10, s9), m17.setShader({ ...h11, defines: { ...u11, textRenderPassType: K5.Color, isBackgroundPass: false, isLabel: true } }), m17.submitDraw(e10, s9);
  }
};
...
var k4 = class extends _6 {
  ...
  vertex(t10, e10) {
    ...
    return { ...p14, tlbr: y7, relativePositionAlongLine: h11, relativeGradientSize: u11, isAlongLine: v2(t10.bitset, e4.isAlongLine), isDiscrete: v2(t10.bitset, e4.isDiscrete), ...this.maybeRunHittest(t10, e10, p14.halfWidth) };
  }
  fragment(t10) {
...
var d6 = class extends t8 {
  ...
  _getShaderOptions(e10, t10, a8) {
    ...
    return { shader: this.shaders.geometry, uniforms: { ...m2(e10, t10.target, l10.uniforms), ...h2(e10, t10.target), antialiasingControls: n7(c7), mosaicInfo: p14.textureManager.getMosaicInfo(n15, t10.textureKey), technique: { isColorPass: a8 } }, defines: { ...y(e10) }, optionalAttributes: l10.optionalAttributes, useComputeBuffer: f(e10) };
  }
  render(e10, t10) {
...
var p7 = class extends t8 {
  ...
  render(e10, t10) {
    ...
    a8.setShader({ shader: this.shaders.geometry, uniforms: { ...m2(e10, t10.target, p14.uniforms), ...h2(e10, t10.target), antialiasingControls: n7(u11) }, defines: { ...y(e10) }, optionalAttributes: p14.optionalAttributes, useComputeBuffer: f(e10) }), a8.setPipelineState(M3(e10)), a8.submitDraw(e10, t10);
  }
};
...
var H6 = class extends _6 {
  ...
  vertex(t10, e10) {
    ...
    return { ...a8, tlbr: n15, patternSize: l10, accumulatedDistance: r7, isSDF: c7, sampleAlphaOnly: m17, dashToPx: d10, offsetAlongLine: t10.offsetAlongLine, capType: t10.capType, ...this.maybeRunHittest(t10, e10, a8.halfWidth) };
  }
  fragment(t10) {
...
var p8 = class extends t8 {
  ...
  render(e10, t10) {
    ...
    m17.setShader({ shader: this.shaders.geometry, uniforms: { ...m2(e10, t10.target, f15.uniforms), ...h2(e10, t10.target), antialiasingControls: n7(p14), mosaicInfo: m17.textureManager.getMosaicInfo(a8, t10.textureKey) }, defines: { ...y(e10) }, optionalAttributes: f15.optionalAttributes, useComputeBuffer: f(e10) }), m17.setPipelineState(M3(e10)), m17.submitDraw(e10, t10);
  }
};
...
var et = class extends B5 {
  ...
  vertex(t10, e10) {
    ...
    return { glPosition: N, color: v9, textureUV: D7, outlineColor: F9, outlineSize: g12, distanceToPx: I5, isSDF: r7, overrideOutlineColor: k7, ...this.maybeRunHittest(t10, e10, { pos: t10.pos, size: w9, sizeCorrection: V4, isMapAligned: y7, vvRotationMat3: _9, placementMat3: z7, outlineSize: g12, distanceToPx: I5, isSDF: r7 }) };
  }
  fragment(t10) {
...
var u6 = class extends t8 {
  ...
  render(e10, t10) {
    const { context: a8, painter: m17 } = e10, u11 = t10.instance.getInput();
    m17.setShader({ shader: this.shaders.geometry, uniforms: { ...m2(e10, t10.target, u11.uniforms), ...h2(e10, t10.target), mosaicInfo: m17.textureManager.getMosaicInfo(a8, t10.textureKey, true) }, defines: { ...y(e10) }, optionalAttributes: u11.optionalAttributes, useComputeBuffer: f(e10) }), m17.setPipelineState(M3(e10)), m17.submitDraw(e10, t10);
  }
};
...
var m12 = class extends t8 {
  ...
  render(e10, s9) {
    const { context: n15, painter: u11 } = e10, m17 = y(e10), p14 = s9.instance.getInput(), f15 = { shader: this.shaders.geometry, uniforms: { ...m2(e10, s9.target, p14.uniforms), ...h2(e10, s9.target), mosaicInfo: u11.textureManager.getMosaicInfo(n15, s9.textureKey) }, defines: { ...m17, isBackgroundPass: true, isLabel: false, textRenderPassType: K5.Color }, optionalAttributes: p14.optionalAttributes, useComputeBuffer: f(e10) };
    u11.setShader(f15), u11.setPipelineState(M3(e10)), u11.submitDraw(e10, s9), u11.setShader({ ...f15, defines: { ...m17, isBackgroundPass: false, isLabel: false, textRenderPassType: K5.Halo } }), u11.submitDraw(e10, s9), u11.setShader({ ...f15, defines: { ...m17, isBackgroundPass: false, isLabel: false, textRenderPassType: K5.Outline } }), u11.submitDraw(e10, s9), u11.setShader({ ...f15, defines: { ...m17, isBackgroundPass: false, isLabel: false, textRenderPassType: K5.Color } }), u11.submitDraw(e10, s9);
  }
};
...
function c5(e10) {
  ...
  return "string" == typeof e10 ? e10 : { ...e10, defaultValue: c5(e10?.defaultValue) };
}
async function u9(a8, i11) {
  const { cimResourceManager: l10, cimAnalyzer: t10, scaleExpression: n15 } = i11.schemaOptions;
  await Promise.all(te.fetchResources(a8.symbol, l10, []));
...
function b8(e10, a8, i11) {
  ...
  if (e10.animationParams) {
    ...
    return p12(r7.ensureInstance(a9, { uniforms: { ...s9, visualVariableSizeMinMaxValue: null, visualVariableSizeStops: null, visualVariableSizeUnitValue: null, visualVariableSizeScaleStops: null, visualVariableRotation: null }, optionalAttributes: { zoomRange: true, value1Position2Value2: false, lineLength: false } }), e10, z5, i11);
  }
...
function I4(e10, a8, i11) {
  const { uniforms: t10, schemaOptions: o14 } = a8, { store: r7 } = o14, s9 = e10.isOutline ? { ...z5, visualVariableSizeScaleStops: t10.visualVariableSizeOutlineScaleStops } : { visualVariableColor: e10.colorLocked ? null : t10.visualVariableColor, visualVariableOpacity: t10.visualVariableOpacity, visualVariableSizeMinMaxValue: t10.visualVariableSizeMinMaxValue, visualVariableSizeScaleStops: t10.visualVariableSizeScaleStops, visualVariableSizeStops: t10.visualVariableSizeStops, visualVariableSizeUnitValue: t10.visualVariableSizeUnitValue };
  if (e10.animationParams) {
    const { hasShiftAnimation: a9 } = e10.animationParams.params, t11 = F8.animatedLine;
    return p12(r7.ensureInstance(t11, { uniforms: { ...s9, visualVariableRotation: null }, optionalAttributes: { zoomRange: true, value1Position2Value2: false, accumulatedDistance: true, segmentDirection: true, normal: true, lineLength: a9 } }), e10, z5, i11);
  }
...
function R8(e10, a8, i11, l10) {
  ...
  return [e10.createMeshInfo({ ...M5(a8, i11, l10), offsetAlongLine: a8.offsetAlongLine ?? 0, shouldScaleDash: n15 ?? false, shouldSampleAlphaOnly: o14, isSDF: "CIMPictureStroke" !== t10.resource.type && "CIMGradientStroke" !== t10.resource.type, sprite: t10 })];
}
function k6(e10, a8, i11) {
  const { uniforms: t10, schemaOptions: o14 } = a8, { store: r7 } = o14;
  return C8(r7.ensureInstance(F8.gradientStroke, { uniforms: e10.isOutline ? { ...z5, visualVariableSizeScaleStops: t10.visualVariableSizeOutlineScaleStops } : { visualVariableColor: null, visualVariableOpacity: t10.visualVariableOpacity, visualVariableSizeMinMaxValue: t10.visualVariableSizeMinMaxValue, visualVariableSizeScaleStops: t10.visualVariableSizeScaleStops, visualVariableSizeStops: t10.visualVariableSizeStops, visualVariableSizeUnitValue: t10.visualVariableSizeUnitValue }, optionalAttributes: { zoomRange: !!i11.scaleInfo } }), e10, i11);
}
function C8(e10, a8, i11) {
  if (!a8.spriteRasterizationParam) throw new Error("InternalError: Sprite should always be defined");
  const l10 = a8.spriteRasterizationParam;
  return [e10.createMeshInfo({ ...M5(a8, false, i11), gradientMethod: a8.gradientMethod, gradientSize: a8.gradientSize, gradientSizeUnits: a8.gradientSizeUnits, gradientType: a8.gradientType, sprite: l10, effects: a8.effects ? { type: "cim-effect-infos", effectInfos: a8.effects } : null })];
}
...
var o12 = class {
  constructor(e10) {
    this.updateTracking = new d2({ debugName: "FeatureCommandQueue" }), this.process = e10.process, this._queueProcessor = new _({ concurrency: 1, process: async (e11) => {
      if ("override-batch" === e11.type) {
        ...
        return this._nextOverrideBatch = null, await this.process(e12), void e12.resolve();
      }
...
//# sourceMappingURL=chunk-MMXQRX2B.js.map
