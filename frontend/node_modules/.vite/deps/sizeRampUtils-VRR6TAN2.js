import {
  g
} from "./chunk-IM5LTYPG.js";
import "./chunk-LRGEISLI.js";
import "./chunk-R62BLGYS.js";
import "./chunk-32OPVXNE.js";
import "./chunk-Z6MYVXBY.js";
import {
  c,
  i,
  l as l2,
...
async function H(e2, t2, o, i3) {
  const n2 = (await import("./visualVariableUtils-DXOCSDRL.js")).getSizeRangeAtScale(e2, o, i3), r2 = n2 && O(n2);
  if (!n2 || !r2) return;
...
async function G2(e2, t2, l3, o, i3) {
  const { getSize: n2 } = await import("./visualVariableUtils-DXOCSDRL.js");
...
//# sourceMappingURL=sizeRampUtils-VRR6TAN2.js.map
