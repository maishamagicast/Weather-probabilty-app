...
var p3 = class _p {
  constructor(i6, e10, s6 = null, h6 = n3.Mesh, r8 = null, o6 = -1) {
    ...
    for (const [t4, a3] of e10) this._attributes.set(t4, { ...a3, indices: e4(a3.indices) }), t4 === e3.POSITION && (this.edgeIndicesLength = this.edgeIndicesLength < 0 ? this._attributes.get(t4).indices.length : this.edgeIndicesLength);
  }
  instantiate(t4 = {}) {
...
//# sourceMappingURL=chunk-KDETRKVX.js.map
