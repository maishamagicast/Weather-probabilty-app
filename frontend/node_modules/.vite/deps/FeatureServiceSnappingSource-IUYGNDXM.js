...
var d4 = class extends b {
  constructor(e5) {
    super(e5), this.updating = false, this.enablePolygons = true, this.enableLabels = true, this._polygons = /* @__PURE__ */ new Map(), this._labels = /* @__PURE__ */ new Map(), this._symbols = u3.map(((e6) => new m2({ color: [e6[0], e6[1], e6[2], 0.6], outline: { color: "black", width: 1 } }))), this._enabled = true;
  }
  initialize() {
    this.update();
  }
...
var O = class extends b {
  ...
  constructor(e5) {
    super(e5), this._updatingHandles = new h3(), this._workerHandle = null, this._debug = null, this._memoizedMakeGetGroundElevation = t2(i2);
  }
  initialize() {
    let e5;
    const t3 = this.view;
  ...
  _getOrLoadWhereFields(e5, t3) {
    ...
    if (!this._loadWhereModuleTask && !i3) {
      const e6 = d2((async () => {
        const e7 = await import("./WhereClause-JQBYJNY4.js");
...
//# sourceMappingURL=FeatureServiceSnappingSource-IUYGNDXM.js.map
