...
var t = { exports: {} };
function n() {
  return e || (e = 1, r = t, n2 = "undefined" != typeof document ? document.currentScript?.src : void 0, a2 = async function(r2 = {}) {
    ...
    "undefined" != typeof document && document.currentScript && (s = document.currentScript.src), n2 && (s = n2), s = s.startsWith("blob:") ? "" : s.slice(0, s.replace(/[?#].*/, "").lastIndexOf("/") + 1), a3 = async (r3) => {
    ...
    var Ne = { k: Y, y: q, l: or, t: ur, q: gr, r: yr, B: Er, p: _r, c: zr, h: Gr, b: Yr, C: re, n: se, m: fe, d: ce, u: le, i: pe, s: ve, a: br, o: de, A: he, g: ye, j: we, e: Te, f: Ae, v: Ce, z: Fe, w: Se, x: $e }, Le = await M();
    Le.E;
...
//# sourceMappingURL=lyr3DMain-PHTR2FXL.js.map
