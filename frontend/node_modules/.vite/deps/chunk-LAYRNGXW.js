...
function g3(n15) {
  return n15 && _4() ? p(n15) ?? w3(`0° 0' 0" N | ${n15}`)?.longitude ?? w3(`0 N | ${n15}`)?.longitude ?? null : null;
}
function m2(n15) {
  return n15 && _4() ? p(n15) ?? w3(`${n15} | 0° 0' 0" E`)?.latitude ?? w3(`${n15} | 0 E`)?.latitude ?? null : null;
}
function k(e6) {
...
function x3(t6) {
  return o3(t6, { signDisplay: "exceptZero", ...b3(v2) });
}
function j3(t6) {
...
function R3(t6) {
  const n15 = T(t6);
  return o3(n15, { style: "unit", unitDisplay: "narrow", unit: "degree", signDisplay: n15 > 0 ? "never" : "exceptZero", ...b3(v2) });
}
function $3(t6) {
  return U3(t6, t6.rotationType, v2);
}
...
var S4 = class extends O {
  ...
  loadDependencies() {
    return c({ button: () => import("./calcite-button-3AWD2CWT.js"), icon: () => import("./calcite-icon-5GLXDGPE.js"), input: () => import("./calcite-input-SUU7HPEH.js") });
  }
  ...
  async exitInputMode({ focusOnView: t6 = true } = {}) {
    try {
      ...
      await this._transitionTo("feedback"), s9 instanceof HTMLElement && s9.focus();
    } catch (e6) {
      f(e6);
    }
  }
  ...
  async _transitionTo(t6, o7) {
    ...
    const s9 = async () => {
      this.destroyed || (this._mode = t6, await M(), this.destroyed || (this.renderNow(), await M(), this.destroyed || o7?.()));
    };
    if (!this.domNode?.firstChild || !document.startViewTransition || o5()) return void await s9();
    this.autoRenderingEnabled = false;
    const i11 = this._transitionInfo = { transition: document.startViewTransition((async () => {
      this.destroyed || i11 !== this._transitionInfo || (this.autoRenderingEnabled = true, await s9());
    })), mode: t6 };
    try {
...
var _6 = class extends O {
  ...
  loadDependencies() {
    return c({ button: () => import("./calcite-button-3AWD2CWT.js"), icon: () => import("./calcite-icon-5GLXDGPE.js"), input: () => import("./calcite-input-SUU7HPEH.js"), "input-message": () => import("./calcite-input-message-YMDPSNYD.js") });
  }
  render() {
...
var p7 = class extends O {
  ...
  loadDependencies() {
    return c({ button: () => import("./calcite-button-3AWD2CWT.js"), dropdown: () => import("./calcite-dropdown-2TSUIHKU.js"), "dropdown-item": () => import("./calcite-dropdown-item-GZEFR467.js"), "dropdown-group": () => import("./calcite-dropdown-group-UMYOAIQK.js") });
  }
...
var b4 = class extends o2.EventedAccessor {
  ...
  async enterInputMode(t6) {
    ...
    await this.content?.enterInputMode(t6, i11);
  }
  async exitInputMode(t6) {
    await this.content?.exitInputMode(t6);
  }
  onDragStart(t6, e6) {
    this._prevXY = [t6, e6];
  }
...
function C5(n15, r5) {
  let i11 = null;
  return t([n15.on("paste", (async (o7) => {
    i11?.abort(), i11 = d((async () => {
      _4() || await E(), J4(o7, n15.info, r5);
    }));
  })), d((() => E())), e((() => i11?.abort()))]);
}
...
//# sourceMappingURL=chunk-LAYRNGXW.js.map
