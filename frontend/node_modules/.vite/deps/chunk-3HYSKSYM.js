...
function b(e, t) {
  ...
  return d2({ fields: e.fields ?? [], ignoreFieldTypes: t?.ignoreFieldTypes || I, sortDisabled: t?.sortDisabled }).map(((t2) => new n2({ fieldName: t2.name, isEditable: W(t2, e), label: t2.alias, format: g(t2), visible: c(t2, { ...e, visibleFieldNames: i }) })));
}
function g(e) {
  switch (e.type) {
    case "small-integer":
...
//# sourceMappingURL=chunk-3HYSKSYM.js.map
