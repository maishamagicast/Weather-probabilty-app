...
var g4 = class {
  constructor(e3, r8, n6, a5 = E) {
    this.locations = a5, this.primitiveType = R.TRIANGLES, this.key = r8.key, this._program = new r6(e3.rctx, n6.get().build(r8), a5), this._pipeline = this.initializePipeline(r8), this.reload = async (t3) => {
      t3 && await n6.reload(), this.key.equals(r8.key) || m4().warn("Configuration was changed after construction, cannot reload shader.", n6), r2(this._program), this._program = new r6(e3.rctx, n6.get().build(r8), a5), this._pipeline = this.initializePipeline(r8);
    };
  }
  destroy() {
...
//# sourceMappingURL=chunk-AGT5DX6L.js.map
