...
var c = class extends U {
  constructor(...e) {
    super(...e), this.portalItem = null, this.isReference = null, this.tileInfo = new j({ size: [256, 256], dpi: 96, format: "png8", compressionQuality: 0, origin: new _({ x: -20037508342787e-6, y: 20037508342787e-6, spatialReference: f.WebMercator }), spatialReference: f.WebMercator, lods: [new l({ level: 0, scale: 591657527591555e-6, resolution: 156543.033928 }), new l({ level: 1, scale: 295828763795777e-6, resolution: 78271.5169639999 }), new l({ level: 2, scale: 147914381897889e-6, resolution: 39135.7584820001 }), new l({ level: 3, scale: 73957190948944e-6, resolution: 19567.8792409999 }), new l({ level: 4, scale: 36978595474472e-6, resolution: 9783.93962049996 }), new l({ level: 5, scale: 18489297737236e-6, resolution: 4891.96981024998 }), new l({ level: 6, scale: 9244648868618e-6, resolution: 2445.98490512499 }), new l({ level: 7, scale: 4622324434309e-6, resolution: 1222.99245256249 }), new l({ level: 8, scale: 2311162217155e-6, resolution: 611.49622628138 }), new l({ level: 9, scale: 1155581108577e-6, resolution: 305.748113140558 }), new l({ level: 10, scale: 577790.554289, resolution: 152.874056570411 }), new l({ level: 11, scale: 288895.277144, resolution: 76.4370282850732 }), new l({ level: 12, scale: 144447.638572, resolution: 38.2185141425366 }), new l({ level: 13, scale: 72223.819286, resolution: 19.1092570712683 }), new l({ level: 14, scale: 36111.909643, resolution: 9.55462853563415 }), new l({ level: 15, scale: 18055.954822, resolution: 4.77731426794937 }), new l({ level: 16, scale: 9027.977411, resolution: 2.38865713397468 }), new l({ level: 17, scale: 4513.988705, resolution: 1.19432856685505 }), new l({ level: 18, scale: 2256.994353, resolution: 0.597164283559817 }), new l({ level: 19, scale: 1128.497176, resolution: 0.298582141647617 })] }), this.subDomains = ["a", "b", "c"], this.urlTemplate = "https://{subDomain}.tile.openstreetmap.org/{level}/{col}/{row}.png", this.operationalLayerType = "OpenStreetMap", this.type = "open-street-map", this.fullExtent = new z(-20037508342787e-6, -2003750834278e-5, 2003750834278e-5, 20037508342787e-6, f.WebMercator), this.copyright = "Map data &copy; OpenStreetMap contributors, CC-BY-SA";
  }
  get refreshInterval() {
    return 0;
  }
};
r([m({ type: k, json: { read: false, write: false, origins: { "web-document": { read: false, write: false } } } })], c.prototype, "portalItem", void 0), r([m({ type: Boolean, json: { read: false, write: false } })], c.prototype, "isReference", void 0), r([m({ type: Number, readOnly: true, json: { read: false, write: false, origins: { "web-document": { read: false, write: false } } } })], c.prototype, "refreshInterval", null), r([m({ type: j, json: { write: false } })], c.prototype, "tileInfo", void 0), r([m({ type: ["show", "hide"] })], c.prototype, "listMode", void 0), r([m({ readOnly: true, json: { read: false, write: false } })], c.prototype, "subDomains", void 0), r([m({ readOnly: true, json: { read: false, write: false } })], c.prototype, "urlTemplate", void 0), r([m({ type: ["OpenStreetMap"] })], c.prototype, "operationalLayerType", void 0), r([m({ json: { read: false } })], c.prototype, "type", void 0), r([m({ readOnly: true, json: { read: false, write: false }, nonNullable: true })], c.prototype, "fullExtent", void 0), r([m({ json: { read: false, write: false } })], c.prototype, "copyright", void 0), r([m({ json: { read: false, write: false } })], c.prototype, "wmtsInfo", void 0), c = r([a("esri.layers.OpenStreetMapLayer")], c);
var u = c;
export {
  u as default
};
//# sourceMappingURL=OpenStreetMapLayer-AOXV23QF.js.map
