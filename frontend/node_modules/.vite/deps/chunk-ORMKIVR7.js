...
var p2 = u3 = class extends b {
  ...
  toRequestOptions(t2, r2) {
    ...
    return this.sortField && (i3.sortField = this.sortField.split(",").map(((t3) => m2.toJSON(t3.trim()))).join(","), i3.sortOrder = this.sortOrder), { query: { ...r2, ...i3 } };
  }
};
...
var u5 = n3 = class extends l2 {
  ...
  async deleteItems(t2, r2 = false) {
    ...
    if (l4.length) {
      const i3 = { method: "post", query: { items: l4.join(","), permanentDelete: r2 } }, n4 = await this.portal.request(o3, i3);
  ...
  async fetchItems(t2) {
    ...
    const { default: r2 } = await import("./PortalItem-42T3FK5G.js"), o3 = { folders: false, inRecycleBin: !!t2.inRecycleBin || null, foldersContent: !(t2.folder || !t2.includeSubfolderItems) || null, num: t2.num || 10, start: t2.start || 1, sortField: t2.sortField || "created", sortOrder: t2.sortOrder || "asc" }, s5 = await this.portal.request(e2, { query: o3 });
    let l4;
...
var M;
var U;
var Q = { PortalGroup: () => Promise.resolve({ default: u4 }), PortalItem: () => import("./PortalItem-42T3FK5G.js"), PortalUser: () => Promise.resolve({ default: u5 }) };
var _a;
var C = (_a = class extends l2.JSONSupportMixin(p) {
  ...
  load(e2) {
    const t2 = import("./@arcgis_core_Basemap.js").then((({ default: t3 }) => {
      s4(e2), U = t3;
  ...
  async createElevationLayers() {
    await this.load();
    const e2 = this._getHelperService("defaultElevationLayers"), t2 = (await import("./ElevationLayer-7PFDPFH6.js")).default;
  ...
  fetchSelf(e2 = this.authMode, t2 = false, r2) {
    const o3 = this.restUrl + "/portals/self", s5 = { authMode: e2, query: { culture: i2().toLowerCase() }, withCredentials: true, ...r2 };
    return "auto" === s5.authMode && (s5.authMode = "no-prompt"), t2 && (s5.query.default = true), this.request(o3, s5);
  }
  queryPortal(e2, t2, r2, o3) {
    const s5 = w(p2, t2), i3 = (t3) => this.request(this.restUrl + e2, { ...s5.toRequestOptions(this), ...o3 }).then(((e3) => {
      const r3 = s5.clone();
  ...
  request(e2, t2 = {}) {
    const r2 = { f: "json", ...t2.query }, { authMode: s5 = this.authMode === M.AUTH_MODE_ANONYMOUS || this.authMode === M.AUTH_MODE_NO_PROMPT ? this.authMode : "auto", body: i3 = null, cacheBust: a4 = false, method: l4 = "auto", responseType: u6 = "json", signal: n4 } = t2, p4 = { authMode: s5, body: i3, cacheBust: a4, method: l4, query: r2, responseType: u6, timeout: 0, signal: n4 };
  ...
  async _fetchBasemaps(e2, t2) {
    ...
    const i3 = await s5.queryItems(r2, t2);
    if (!i3.total) return [];
...
//# sourceMappingURL=chunk-ORMKIVR7.js.map
