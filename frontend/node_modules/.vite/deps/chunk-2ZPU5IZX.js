...
function r3(e13, n7, r10, o12 = {}) {
  has("esri-deprecation-warnings") && m(e13, `This widget is deprecated. Use the ${n7} component instead.`, { see: [`${n7} component reference: ${t}${r10}/`, `Esri's move to web components: ${t}components-transition-plan/`], replacement: `<${r10}></${r10}>`, warnOnce: true, ...o12 });
}
function o4(e13, n7, r10, o12 = {}) {
  has("esri-deprecation-warnings") && m(e13, `This view model is deprecated. Use the ${n7} component directly instead.`, { see: [`${n7} component reference: ${t}${r10}/`, `Esri's move to web components: ${t}components-transition-plan/`], replacement: `<${r10}></${r10}>`, warnOnce: true, ...o12 });
}
...
function p(e13, n7, t10 = {}) {
  has("esri-deprecation-warnings") && m(e13, `Multiple argument constructor: ${n7}`, { warnOnce: true, replacement: `new ${n7}({ <your properties here> })`, ...t10 });
}
...
var s4 = class extends s2 {
  constructor(t10) {
    super(new i5(t10)), this._observer && e7.register(this, new WeakRef(this._observer), this);
  }
  destroy() {
    this._observer && e7.unregister(this._observer), this.accessed?.clear(), this.clear(), this._observer?.destroy();
  }
};
var i5 = class {
  constructor(t10) {
...
var e7 = new FinalizationRegistry(((t10) => {
  t10.deref()?.destroy();
}));
function r5() {
}
...
var _m = class _m {
  ...
  acquire(e13, t10, r10, l3, o12, i9, n7) {
    this.uid = e6(), this.removed = false, this.type = e13, this.oldValue = t10, this.callback = r10, this.getValue = l3, this.target = o12, this.path = i9, this.equals = n7;
  }
  release() {
...
//# sourceMappingURL=chunk-2ZPU5IZX.js.map
