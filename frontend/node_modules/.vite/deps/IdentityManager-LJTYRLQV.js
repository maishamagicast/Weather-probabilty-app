...
var m3 = class extends O {
  ...
  loadDependencies() {
    return c2({ button: () => import("./calcite-button-2FBES7TO.js"), dialog: () => import("./calcite-dialog-QAP2DF3K.js"), input: () => import("./calcite-input-RV552V7I.js"), label: () => import("./calcite-label-JSJ3EUXN.js"), notice: () => import("./calcite-notice-HNGSCYOY.js") });
  }
  get title() {
...
var j2 = class extends o2 {
  ...
  getCredential(e3, t3) {
    ...
    t3 && (s8 = !(!t3.token && !t3.credential), r4 = t3.error, o3 = false !== t3.prompt), t3 = { ...t3 }, e3 = this._sanitizeUrl(e3);
  ...
  generateToken(e3, t3, r4) {
    ...
    const v2 = { query: { request: "getToken", username: t3?.username, password: t3?.password, serverUrl: l3, token: c3, expiration: m4, referer: h2 || o3 ? this._appOrigin : null, client: h2 ? "referer" : null, f: "json", ...e3.customParameters }, method: "post", authMode: "anonymous", useProxy: this._useProxy(e3, r4), signal: f, ...r4?.ioArgs };
  ...
  async _exchangeToken(e3, t3, r4) {
    return (await H(`${e3}/sharing/rest/oauth2/exchangeToken`, { authMode: "anonymous", method: "post", query: { f: "json", client_id: t3, token: r4 } })).data.token;
  }
  async _getPlatformSelf(e3, t3) {
    ...
    try {
      const r4 = await H(`${e3}/sharing/rest/oauth2/platformSelf`, { authMode: "anonymous", headers: { "X-Esri-Auth-Client-Id": t3, "X-Esri-Auth-Redirect-Uri": window.location.href.replace(/#.*$/, "") }, method: "post", query: { f: "json", expiration: 30 }, withCredentials: true });
...
//# sourceMappingURL=IdentityManager-LJTYRLQV.js.map
