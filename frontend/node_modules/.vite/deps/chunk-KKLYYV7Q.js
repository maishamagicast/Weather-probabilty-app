...
var t = class {
  ...
  peekLast() {
    return 0 === this.size ? null : this._buffer[(this._start + (this.size - 1)) % this.maxSize];
  }
  find(t2) {
    if (0 === this.size) return null;
    for (const s of this._buffer) if (null != s && t2(s)) return s;
    return null;
  }
  clear(t2) {
    let s = this.dequeue();
    for (; null != s; ) t2 && t2(s), s = this.dequeue();
  }
};
...
//# sourceMappingURL=chunk-KKLYYV7Q.js.map
