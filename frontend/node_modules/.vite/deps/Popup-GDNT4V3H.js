import {
  x
} from "./chunk-Q67P4MXT.js";
import {
  t as t2
} from "./chunk-ELIP33PA.js";
import "./chunk-EMQWPEYG.js";
import "./chunk-HD32LD5D.js";
...
import {
  ...
  ne,
  t
} from "./chunk-WDCF6FIU.js";
import "./chunk-JUDSBNS5.js";
import "./chunk-OG7E7GTZ.js";
import "./chunk-BEG7723P.js";
import "./chunk-YOLEQXVO.js";
import "./chunk-NQUKPCC3.js";
...
import "./chunk-4SZLGQU3.js";
import "./chunk-GU7BZV6H.js";
...
var e7 = () => c2({ action: () => import("./calcite-action-E4CIBGMF.js") });
...
var f5 = class extends O {
  ...
  loadDependencies() {
    return Promise.all([e7(), c2({ action: () => import("./calcite-action-E4CIBGMF.js"), "action-bar": () => import("./calcite-action-bar-IPA4EOAB.js"), "action-group": () => import("./calcite-action-group-BLDQJRMK.js"), "flow-item": () => import("./calcite-flow-item-5MF6UOQA.js") })]);
  }
  render() {
  ...
  constructor(e11) {
    super(e11), this._pendingPromises = new t2(), this._fetchFeaturesController = null, this._highlightPromises = { "highlight-active-feature": null, "highlight-selected-feature": null }, this._selectedClusterFeature = null, this.actions = new i5(), this.activeFeature = null, this.autoCloseEnabled = false, this.browseClusterEnabled = false, this.content = null, this.defaultPopupTemplateEnabled = false, this.featurePage = null, this.featuresPerPage = 20, this.featureMenuOpen = false, this.featureMenuTitle = null, this.featureViewModelAbilities = null, this.featureViewModels = [], this.highlightEnabled = true, this.includeDefaultActions = true, this.initialDisplayMode = "feature", this.selectedClusterBoundaryFeature = new d2({ symbol: new m2({ outline: { width: 1.5, color: "cyan" }, style: "none" }) }), this.title = null, this.updateLocationEnabled = false, this.view = null, this.visible = false, this.zoomFactor = 4, this.zoomToLocation = null, this._debouncedLocationUpdate = k((async (e12) => {
      ...
      if (i6 && "mesh" !== i6 && t5 && s4 && this.selectedFeature) if ("point" !== i6) try {
        ...
        i7 = O2(i7, t5), G || (G = await Promise.all([await import("./intersectsOperator-7QUJBUHO.js"), await import("./proximityOperator-SDQA5IDF.js")]));
        const [a8, n8] = G;
        if (!a8.execute(i7, s4)) {
...
var H2 = class extends n3(O) {
  ...
  loadDependencies() {
    return Promise.all([e7(), c2({ action: () => import("./calcite-action-E4CIBGMF.js"), "action-bar": () => import("./calcite-action-bar-IPA4EOAB.js"), "action-group": () => import("./calcite-action-group-BLDQJRMK.js"), button: () => import("./calcite-button-2FBES7TO.js"), icon: () => import("./calcite-icon-5GLXDGPE.js"), flow: () => import("./calcite-flow-4J5PU2ET.js"), "flow-item": () => import("./calcite-flow-item-5MF6UOQA.js"), list: () => import("./calcite-list-C4NKUKZM.js"), "list-item": () => import("./calcite-list-item-XXGFZRSJ.js"), "list-item-group": () => import("./calcite-list-item-group-YCQPMBGR.js"), loader: () => import("./calcite-loader-GBIWPGQS.js") })]);
  }
  destroy() {
...
//# sourceMappingURL=Popup-GDNT4V3H.js.map
