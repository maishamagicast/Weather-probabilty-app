import {
  ...
  I as I2,
  N
} from "./chunk-IZELOUI5.js";
import {
  d
} from "./chunk-WGFZQTVH.js";
import {
  u
...
async function v(n2, o, s2 = {}, a = 5) {
  ...
  const { apiKey: u2, customParameters: d2, signal: f2 } = s2, g = _(c.href, n2.landingPage.url), w = { limit: a, ...d2, token: u2 }, T2 = Ht(g, w), k2 = { accept: S.geojson }, { data: x2 } = await H(T2, { signal: f2, headers: k2 }), v2 = A(T2, a, x2.links) ?? I3;
  E(x2);
...
async function O(n2, r = {}) {
  ...
  const { apiKey: l, customParameters: c, signal: u2 } = r, d2 = _(a.href, s2), { data: f2 } = await H(d2, { signal: u2, headers: { accept: S.json }, query: { ...c, token: l } });
  for (const e2 of f2.collections) e2.landingPage = n2;
  return f2;
}
async function P(n2, r = {}) {
...
async function q(t, n2 = {}) {
  const { apiKey: i3, customParameters: r, signal: o } = n2, { data: s2 } = await H(t, { signal: o, headers: { accept: S.json }, query: { ...r, token: i3 } });
  return s2.url = t, s2;
}
async function N2(t, n2 = {}) {
  ...
  const { apiKey: a, customParameters: l, signal: c } = n2, u2 = _(s2.href, o), { data: d2 } = await H(u2, { signal: c, headers: { accept: S.openapi }, query: { ...l, token: a } });
  return d2;
}
function C(e2) {
...
//# sourceMappingURL=chunk-LXRWAPXG.js.map
