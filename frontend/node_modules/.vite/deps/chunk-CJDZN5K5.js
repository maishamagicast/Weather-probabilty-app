...
function K(n2) {
  return null == E && (E = Promise.all([_(), import("./geometryEngineBase-WFFY4YBO.js").then(((n3) => n3.g)), import("./hydrated-S6H27PG7.js")])), E.then((([, r3, { hydratedAdapter: t3 }]) => {
...
async function J(n2, e2, r3) {
  const t3 = n2.spatialReference;
  return null != t3 && null != e2 && await Q(t3, e2, null, r3), I(n2, e2);
}
function L(n2, e2, r3) {
...
//# sourceMappingURL=chunk-CJDZN5K5.js.map
