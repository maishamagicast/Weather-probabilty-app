...
async function o2(o3) {
  const a2 = "portalItem" in o3 ? o3 : { portalItem: o3 }, { fromItem: e } = await import("./portalLayers-HCON2CXK.js");
  try {
    return await e(a2);
  } catch (p2) {
...
var h = class extends o.EventedMixin(n.IdentifiableMixin(p)) {
  ...
  static async fromArcGISServerUrl(e) {
    ...
    return (await import("./arcgisLayers-SXHJO5R5.js")).fromUrl(t);
  }
  ...
  async fetchAttributionData() {
    ...
    if (this.hasAttributionData && e) {
      return (await H(e, { query: { f: "json" }, responseType: "json" })).data;
    }
...
//# sourceMappingURL=chunk-R25QZWQ7.js.map
