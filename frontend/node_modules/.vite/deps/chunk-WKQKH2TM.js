...
async function c(t2) {
  ...
  const u2 = new FontFace(t2.family, `url('${s.fontsUrl}/woff2/${a}.${n}') format('${n}')`, { style: t2.style, weight: t2.weight }), d2 = document.fonts;
...
//# sourceMappingURL=chunk-WKQKH2TM.js.map
