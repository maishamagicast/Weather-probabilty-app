import {
  ...
  x,
  y as y2
} from "./chunk-CLYIM6UH.js";
import {
  n as n4,
  t as t2,
  v as v2
} from "./chunk-QPHMQOMH.js";
import {
  D
} from "./chunk-VSSLF37V.js";
import {
  A,
  I as I2,
  R,
  ...
  k,
  x as x2
} from "./chunk-NWM4666Y.js";
import {
  j
} from "./chunk-AUL2ONNS.js";
import {
  $,
  G,
  H as H2,
...
var H3;
async function F() {
  null == H3 && (H3 = await import("./operators-G5NSIETN.js"), await H3.loadAll());
}
function K(F4, K4) {
...
async function Qe() {
  return Te2([await import("./geomasync-N554ME6J.js")], "async"), true;
}
...
var K2 = class {
  ...
  parsePrimaryExpression() {
    ...
    switch (u4.type) {
      case h3.Identifier:
        return this.readNextRawToken(), this.finalize({ type: i3.Identifier, name: u4.value, ...this.getItemLocation(t5) });
      case h3.NumericLiteral:
      case h3.StringLiteral:
        return this.context.isAssignmentTarget = false, this.readNextRawToken(), this.finalize({ type: i3.Literal, value: u4.value, raw: this.getSourceValue(u4), isString: "string" == typeof u4.value, ...this.getItemLocation(t5) });
      case h3.BooleanLiteral:
        return this.context.isAssignmentTarget = false, this.readNextRawToken(), this.finalize({ type: i3.Literal, value: u4.value.toLowerCase() === e3.True, raw: this.getSourceValue(u4), isString: false, ...this.getItemLocation(t5) });
      case h3.NullLiteral:
        return this.context.isAssignmentTarget = false, this.readNextRawToken(), this.finalize({ type: i3.Literal, value: null, raw: this.getSourceValue(u4), isString: false, ...this.getItemLocation(t5) });
      case h3.Template:
  ...
  parseArrayInitializer() {
    ...
    return this.expectPunctuator("]"), this.finalize({ type: i3.ArrayExpression, elements: t5, ...this.getItemLocation(e6) });
  }
  parseObjectPropertyKey() {
    let e6 = this.captureStartMarker(), t5 = this.rawToken;
    switch (t5.type) {
      case h3.StringLiteral:
        return this.readNextRawToken(), this.finalize({ type: i3.Literal, value: t5.value, raw: this.getSourceValue(t5), isString: true, ...this.getItemLocation(e6) });
      case h3.Identifier:
      case h3.BooleanLiteral:
      case h3.NullLiteral:
      case h3.Keyword:
        return this.readNextRawToken(), this.finalize({ type: i3.Identifier, name: t5.value, ...this.getItemLocation(e6) });
      default:
  ...
  parseObjectProperty() {
    ...
    return this.matchPunctuator(":") ? (this.readNextRawToken(), n7 = this.inheritCoverGrammar(this.parseAssignmentExpression.bind(this))) : e6.type === h3.Identifier ? (r4 = true, n7 = this.finalize({ type: i3.Identifier, name: e6.value, ...this.getItemLocation(t5) })) : this.throwUnexpectedToken({ rawToken: this.rawToken }), this.finalize({ type: i3.Property, kind: "init", key: u4, value: n7, shorthand: r4, ...this.getItemLocation(t5) });
  }
  parseObjectExpression() {
    ...
    return this.expectPunctuator("}"), this.finalize({ type: i3.ObjectExpression, properties: t5, ...this.getItemLocation(e6) });
  }
  parseTemplateElement(e6 = false) {
    ...
    let { value: r4, cooked: n7, tail: s6 } = t5, a3 = this.finalize({ type: i3.TemplateElement, value: { raw: r4, cooked: n7 }, tail: s6, ...this.getItemLocation(u4) });
  ...
  parseTemplateLiteral() {
    ...
    return this.finalize({ type: i3.TemplateLiteral, quasis: u4, expressions: t5, ...this.getItemLocation(e6) });
  }
  ...
  parseMemberName() {
    ...
    return this.readNextRawToken(), e6.type !== h3.NullLiteral && e6.type !== h3.Identifier && e6.type !== h3.Keyword && e6.type !== h3.BooleanLiteral && this.throwUnexpectedToken({ rawToken: e6 }), this.finalize({ type: i3.Identifier, name: e6.value, ...this.getItemLocation(t5) });
  }
  parseLeftHandSideExpression() {
    ...
    for (; e6 = this.getMatchingPunctuator("([."); ) switch (e6) {
      case "(": {
        ...
        u4 = this.finalize({ type: i3.CallExpression, callee: u4, arguments: e7, ...this.getItemLocation(t5) });
        continue;
      }
      case "[": {
        this.context.isAssignmentTarget = true, this.expectPunctuator("[");
        let e7 = this.isolateCoverGrammar((() => this.parseExpression()));
        this.expectPunctuator("]"), u4 = this.finalize({ type: i3.MemberExpression, computed: true, object: u4, property: e7, ...this.getItemLocation(t5) });
        continue;
      }
      case ".": {
        this.context.isAssignmentTarget = true, this.expectPunctuator(".");
        let e7 = this.parseMemberName();
        u4 = this.finalize({ type: i3.MemberExpression, computed: false, object: u4, property: e7, ...this.getItemLocation(t5) });
        continue;
      }
    }
    return u4;
  ...
  parseUpdateExpression() {
    ...
    if (t5) {
      ...
      return r4.type !== i3.Identifier && r4.type !== i3.MemberExpression && r4.type !== i3.CallExpression && this.throwError(l3.InvalidExpression, u5), this.context.isAssignmentTarget || this.tolerateError(l3.InvalidLeftHandSideInAssignment, e6), this.context.isAssignmentTarget = false, this.finalize({ type: i3.UpdateExpression, operator: t5, argument: r4, prefix: true, ...this.getItemLocation(e6) });
    }
    ...
    return this.hasLineTerminator || (t5 = this.getMatchingPunctuator(r3), !t5) ? n7 : (n7.type !== i3.Identifier && n7.type !== i3.MemberExpression && this.throwError(l3.InvalidExpression, u4, s6), this.context.isAssignmentTarget || this.tolerateError(l3.InvalidLeftHandSideInAssignment, e6), this.readNextRawToken(), this.context.isAssignmentTarget = false, this.finalize({ type: i3.UpdateExpression, operator: t5, argument: n7, prefix: false, ...this.getItemLocation(e6) }));
  }
  parseUnaryExpression() {
    ...
    if (e6) {
      ...
      return this.context.isAssignmentTarget = false, this.finalize({ type: i3.UnaryExpression, operator: e6, argument: u4, prefix: true, ...this.getItemLocation(t5) });
    }
  ...
  createBinaryOrLogicalExpression(e6, t5, u4, r4) {
    ...
    return n7 === i3.BinaryExpression || ((u4.type === i3.AssignmentExpression || u4.type === i3.UpdateExpression) && this.throwError(l3.InvalidExpression, ...R2(u4)), (r4.type === i3.AssignmentExpression || r4.type === i3.UpdateExpression) && this.throwError(l3.InvalidExpression, ...R2(u4))), { type: n7, operator: t5, left: u4, right: r4, ...this.getItemLocation(e6) };
  }
  parseAssignmentExpression() {
    ...
    return this.finalize({ type: i3.AssignmentExpression, left: t5, operator: r4, right: n7, ...this.getItemLocation(e6) });
  }
  parseExpression() {
  ...
  parseBlock() {
    ...
    return this.expectPunctuator("}"), this.finalize({ type: i3.BlockStatement, body: t5, ...this.getItemLocation(e6) });
  }
  parseObjectStatement() {
    let e6 = this.captureStartMarker(), t5 = this.parseObjectExpression();
    return this.finalize({ type: i3.ExpressionStatement, expression: t5, ...this.getItemLocation(e6) });
  }
  ...
  parseIdentifier() {
    ...
    let t5 = this.captureStartMarker();
    return this.readNextRawToken(), this.finalize({ type: i3.Identifier, name: e6.value, ...this.getItemLocation(t5) });
  }
  parseVariableDeclarator() {
    ...
    return this.finalize({ type: i3.VariableDeclarator, id: t5, init: u4, ...this.getItemLocation(e6) });
  }
  ...
  parseVariableDeclaration() {
    ...
    return this.consumeSemicolon(), this.finalize({ type: i3.VariableDeclaration, declarations: u4, kind: "var", ...this.getItemLocation(e6) });
  }
  parseEmptyStatement() {
    let e6 = this.captureStartMarker();
  ...
  parseExpressionStatement() {
    ...
    return this.consumeSemicolon(), this.finalize({ type: i3.ExpressionStatement, expression: t5, ...this.getItemLocation(e6) });
  }
  parseIfClause() {
  ...
  parseIfStatement() {
    ...
    return this.matchKeyword(t3.Else) && (this.readNextRawToken(), a3 = this.parseIfClause()), this.finalize({ type: i3.IfStatement, test: r4, consequent: s6, alternate: a3, ...this.getItemLocation(e6) });
  }
  parseWhileStatement() {
    let e6 = this.captureStartMarker();
    ...
    return this.finalize({ type: i3.WhileStatement, test: r4, body: s6, ...this.getItemLocation(e6) });
  }
  parseForStatement() {
    ...
    if (this.expectKeyword(t3.For), this.expectPunctuator("("), this.matchKeyword(t3.Var)) {
      ...
      r4 = this.finalize({ type: i3.VariableDeclaration, declarations: s7, kind: "var", ...this.getItemLocation(n8) });
    ...
    return e6 === i3.ForInStatement || e6 === i3.ForOfStatement ? this.finalize({ type: e6, left: a3, right: D4, body: h5, ...this.getItemLocation(o6) }) : this.finalize({ type: e6, init: r4, test: n7, update: s6, body: h5, ...this.getItemLocation(o6) });
  }
  parseContinueStatement() {
    let e6 = this.captureStartMarker();
    return this.expectKeyword(t3.Continue), this.consumeSemicolon(), this.finalize({ type: i3.ContinueStatement, ...this.getItemLocation(e6) });
  }
  parseBreakStatement() {
    let e6 = this.captureStartMarker();
    return this.expectKeyword(t3.Break), this.consumeSemicolon(), this.finalize({ type: i3.BreakStatement, ...this.getItemLocation(e6) });
  }
  parseReturnStatement() {
    ...
    return this.consumeSemicolon(), this.finalize({ type: i3.ReturnStatement, argument: u4, ...this.getItemLocation(e6) });
  }
  parseStatement() {
  ...
  parseFunctionDeclaration() {
    ...
    return this.context.blockContext = n7, this.finalize({ type: i3.FunctionDeclaration, id: u4, params: r4, body: s6, ...this.getItemLocation(e6) });
  }
  parseScript() {
    let e6 = this.captureStartMarker(), t5 = this.parseStatements(), u4 = this.finalize({ type: i3.Program, body: t5, ...this.getItemLocation(e6) });
  ...
  parseExportDeclaration() {
    ...
    return this.expectKeyword(t3.Export), this.matchKeyword(t3.Var) ? e6 = this.parseVariableDeclaration() : this.matchKeyword("function") ? e6 = this.parseFunctionDeclaration() : this.throwUnexpectedToken({ code: l3.InvalidExpression }), this.finalize({ type: i3.ExportNamedDeclaration, declaration: e6, specifiers: [], source: null, ...this.getItemLocation(u4) });
  }
  parseModuleSpecifier() {
    let e6 = this.captureStartMarker(), t5 = this.rawToken;
    if (t5.type === h3.StringLiteral) return this.readNextRawToken(), this.finalize({ type: i3.Literal, value: t5.value, raw: this.getSourceValue(t5), isString: true, ...this.getItemLocation(e6) });
    this.throwError(l3.InvalidModuleUri, e6);
  }
  parseDefaultSpecifier() {
    let e6 = this.captureStartMarker(), t5 = this.parseIdentifier();
    return t5 || this.throwUnexpectedToken({ code: l3.IdentifierExpected }), this.finalize({ type: i3.ImportDefaultSpecifier, local: t5, ...this.getItemLocation(e6) });
  }
...
var _c = class _c {
  ...
  async fetchSource(s6) {
    if ("portal" === s6.scheme) {
      const e6 = await H(s6.url, { responseType: "text", query: {} });
...
async function $3() {
  await Qe(), j3 = await import("./arcadeAsyncRuntime-X7P6XLQ6.js");
...
async function V() {
  await L2();
  const [e6, t5, n7, s6, a3, u4] = await Promise.all([import("./featureSetUtils-BKXBYGVV.js"), import("./featuresetbase-U6CXD63Y.js"), import("./featuresetgeom-SWMKCV2H.js"), import("./featuresetstats-34W6RU66.js"), import("./featuresetstring-PUK44H5O.js"), import("./knowledgegraph-Q7OXGMSE.js")]);
...
async function Q3(e6, r4, t5 = [], n7 = false, s6 = null) {
  return W2(/* @__PURE__ */ new Set(), e6, r4, t5, n7, s6);
}
async function W2(e6, r4, t5, n7 = [], s6 = false, a3 = null) {
  const u4 = "string" == typeof r4 ? F3(r4) : r4, o6 = [];
  return u4 && (false === T3() && (R3(u4) || s6) && o6.push(D3()), false === O2() && (true === u4.isAsync || t5) && o6.push(L2()), false === N2() && (H6(u4) || K3(u4, n7)) && o6.push(B2())), o6.length && await Promise.all(o6), await Y2(e6, u4, a3, t5, s6), true;
}
function X3(e6, r4 = []) {
  return void 0 === e6.usesModules && b(e6, r4), true === e6.usesModules;
}
async function Y2(e6, r4, t5 = null, s6 = false, a3 = false) {
  const c5 = u2(r4);
  ...
  for (const n7 of c5) {
    ...
    e6.add(c6.uri);
    const i4 = await t5.fetchModule(c6);
    await W2(e6, i4, s6, [], a3, t5), e6.delete(c6.uri), i4.isAsync && (r4.isAsync = true), i4.usesFeatureSet && (r4.usesFeatureSet = true), i4.usesGeometry && (r4.usesGeometry = true), r4.loadedModules[n7.libname] = { uri: c6.uri, script: i4 };
  }
}
function Z(e6) {
...
//# sourceMappingURL=chunk-5XLE7B2W.js.map
