...
var e = class {
  constructor(e2, s) {
    this.removeFunc = s, this._storage = new h(), this.id = "", this.name = "", this.size = 0, this._storage.maxSize = e2, this._storage.register(this);
  }
  destroy() {
...
//# sourceMappingURL=chunk-LQQCPLIT.js.map
