...
import {
  t as t2
} from "./chunk-WIK44T5X.js";
import {
  x
} from "./chunk-U67644U5.js";
import {
  Xe
} from "./chunk-C5CBDIA7.js";
import {
  c as c6
} from "./chunk-ROOICUH3.js";
import {
  p as p3
} from "./chunk-4MVMXF4W.js";
import {
  d as d5
...
import {
  ...
  x as x2,
  z
} from "./chunk-G7WXOIZL.js";
import {
  c as c5
} from "./chunk-QHD5R6KE.js";
import {
  o as o2
...
var y3 = class extends b2 {
  ...
  async addAttachment(t6, e14 = this.graphic) {
    ...
    const s12 = i11.addAttachment(e14, t6).then(((t7) => this._queryAttachment(t7.objectId, e14))), o5 = await s12;
    return a7.add(o5), o5;
  }
  async deleteAttachment(t6) {
    ...
    const s12 = e14.deleteAttachments(a7, [t6.id]).then((() => t6)), o5 = await s12;
  ...
  async updateAttachment(t6, e14 = this.activeAttachmentInfo) {
    ...
    const c14 = i11.updateAttachment(r7, e14.id, t6).then(((t7) => this._queryAttachment(t7.objectId))), h8 = await c14;
...
var M2 = class extends O {
  ...
  loadDependencies() {
    return c3({ icon: () => import("./calcite-icon-5GLXDGPE.js") });
  }
  get capabilities() {
...
function e6({ level: r7, class: e14, ...n13 }, l5) {
  const a7 = s9(r7);
  return n2(`h${a7}`, { ...n13, "aria-level": String(a7), class: v(e4.heading, e14), role: "heading" }, l5);
}
function s9(t6) {
...
var v3 = N("short-date");
async function w3(e14, l5, t6) {
  u(e14, l5, (() => [])).push(...t6);
}
async function x3(l5) {
  const t6 = /* @__PURE__ */ new Map();
  if (!l5) return t6;
  if ("visualVariables" in l5 && l5.visualVariables) {
    for (const e14 of l5.visualVariables) if (D2(e14)) {
      const l6 = (await t2(e14) ?? []).map(((e15) => e15.color));
      await w3(t6, e14.field || e14.valueExpression, l6);
    }
  }
  if ("heatmap" === l5.type) {
    const e14 = r5(l5).map(((e15) => e15.color));
    await w3(t6, l5.field || l5.valueExpression, e14);
  } else if ("pie-chart" === l5.type) {
    for (const e14 of l5.attributes) await w3(t6, e14.field || e14.valueExpression, [e14.color]);
    await w3(t6, "default", [l5?.othersCategory?.color, w(l5.backgroundFillSymbol, null)]);
  } else if ("dot-density" === l5.type) {
    for (const e14 of l5.attributes) await w3(t6, e14.field || e14.valueExpression, [e14.color]);
    await w3(t6, "default", [l5.backgroundColor]);
  } else if ("unique-value" === l5.type) if ("predominance" === l5.authoringInfo?.type) for (const e14 of l5.uniqueValueInfos ?? []) await w3(t6, e14.value.toString(), [w(e14.symbol, null)]);
  else {
    const e14 = (l5.uniqueValueInfos ?? []).map(((e15) => w(e15.symbol, null))), { field: i11, field2: o5, field3: a7, valueExpression: n13 } = l5;
    (i11 || n13) && await w3(t6, i11 || n13, e14), o5 && await w3(t6, o5, e14), a7 && await w3(t6, a7, e14);
  }
  else if ("class-breaks" === l5.type) {
    const e14 = l5.classBreakInfos.map(((e15) => w(e15.symbol, null))), { field: i11, valueExpression: o5 } = l5;
    await w3(t6, i11 ?? o5, e14);
  } else "simple" === l5.type && await w3(t6, "default", [w(l5.symbol, null)]);
  return "defaultSymbol" in l5 && l5.defaultSymbol && await w3(t6, "default", [w(l5.defaultSymbol, null)]), t6.forEach(((l6, i11) => {
...
async function $2(e14, t6, r7, i11) {
  ...
  if (b9?.relationshipTableId && b9.keyFieldInRelationshipTable) {
    const t7 = (await S(e14, b9, r7, i11))[e14.attributes[r7.objectIdField]];
    if (!t7) return null;
...
var v5 = class extends b2 {
  constructor(t6) {
    super(t6), this.abilities = { ...I3 }, this.activeMediaInfoIndex = 0, this.attributes = null, this.description = null, this.fieldInfoMap = null, this.formattedAttributes = null, this.expressionAttributes = null, this.isAggregate = false, this.layer = null, this.mediaInfos = null, this.popupTemplate = null, this.relatedInfos = null, this.title = null;
  }
  castAbilities(t6) {
    return { ...I3, ...t6 };
  }
...
var T3 = class extends O {
  constructor(e14, t6) {
    super(e14, t6), this._refreshTimer = null, this._refreshIntervalInfo = null, this._featureElementInfo = null, this._chartRootMap = /* @__PURE__ */ new WeakMap(), this.viewModel = new v5(), this.messages = null, this._disposeChart = (e15) => {
      ...
      const { createRoot: r7 } = await import("./chartUtilsAm5-TNZY75QW.js"), a7 = await r7(e15);
  ...
  async _getSeriesColors(e14) {
    const { colorAm5: t6 } = await import("./chartCommon-6S2Z2NRI.js"), i11 = /* @__PURE__ */ new Map();
    return e14.forEach(((e15) => {
      e15.color && i11.set(e15, t6(e15.color.toCss(true)));
    })), i11;
  }
  async _getRendererColors() {
    const { colorAm5: e14 } = await import("./chartCommon-6S2Z2NRI.js"), t6 = /* @__PURE__ */ new Map(), i11 = this._getRenderer(), r7 = "default";
    if (!i11) return t6;
    const a7 = await x3(i11);
    a7.delete(r7);
  ...
  async _renderChart(e14) {
    const { root: t6, mediaInfo: i11 } = e14, { value: r7, type: a7 } = i11, { ResponsiveThemeAm5: o5, DarkThemeAm5: s12, AnimatedThemeAm5: n13, ColorSetAm5: l5, ThemeAm5: d10, esriChartColorSet: m6 } = await import("./chartCommon-6S2Z2NRI.js"), c14 = d10.new(t6);
    ...
    const p10 = await this._getRendererColors(), u10 = await this._getSeriesColors(r7.series), g8 = l5.new(t6, {}), _5 = u10.get(r7.series[0]), M5 = _5 ? { lineSettings: { stroke: _5 } } : void 0, v9 = r7.series.map(((e15, t7) => {
      const i12 = u10.get(e15) || p10.get(e15.fieldName) || g8.getIndex(t7);
      return { [w5]: e15.tooltip, [A4]: e15.value, columnSettings: { fill: i12, stroke: i12 }, ...M5 };
  ...
  async _customizeChartTooltip(e14, t6 = "horizontal") {
    const { colorAm5: i11 } = await import("./chartCommon-6S2Z2NRI.js");
  ...
  async _createPieChart(e14, t6) {
    const { TooltipAm5: i11 } = await import("./chartCommon-6S2Z2NRI.js"), { PieChartAm5: r7, PieSeriesAm5: a7 } = await import("./pieChart-JWWHDI47.js"), { mediaInfo: o5, root: s12 } = e14, { title: n13 } = o5, l5 = 5, d10 = o5?.altText || o5?.title || "", m6 = s12.container.children.push(r7.new(s12, { ariaLabel: d10, focusable: true, paddingBottom: l5, paddingTop: l5, paddingLeft: l5, paddingRight: l5 })), c14 = "{category}: {valuePercentTotal.formatNumber('0.00')}%\n ({value})", h8 = i11.new(s12, { labelText: c14 }), p10 = m6.series.push(a7.new(s12, { name: n13, valueField: A4, categoryField: w5, tooltip: h8 }));
  ...
  async _createColumnChart(e14, t6, i11) {
    const { TooltipAm5: r7, ScrollbarAm5: a7 } = await import("./chartCommon-6S2Z2NRI.js"), { CategoryAxisAm5: o5, AxisRendererXAm5: s12, ValueAxisAm5: n13, AxisRendererYAm5: l5, ColumnSeriesAm5: d10 } = await import("./xyChart-7XVLQPH7.js"), { mediaInfo: m6, root: c14 } = t6, { value: p10, title: u10 } = m6;
  ...
  async _createBarChart(e14, t6, i11) {
    const { TooltipAm5: r7, ScrollbarAm5: a7 } = await import("./chartCommon-6S2Z2NRI.js"), { CategoryAxisAm5: o5, AxisRendererXAm5: s12, ValueAxisAm5: n13, AxisRendererYAm5: l5, ColumnSeriesAm5: d10 } = await import("./xyChart-7XVLQPH7.js"), { mediaInfo: m6, root: c14 } = t6, { value: p10, title: u10 } = m6;
  ...
  async _createLineChart(e14, t6, i11) {
    const { TooltipAm5: r7, ScrollbarAm5: a7 } = await import("./chartCommon-6S2Z2NRI.js"), { CategoryAxisAm5: o5, AxisRendererXAm5: s12, ValueAxisAm5: n13, AxisRendererYAm5: l5, LineSeriesAm5: d10 } = await import("./xyChart-7XVLQPH7.js"), { root: m6, mediaInfo: c14 } = t6, { value: p10, title: u10 } = c14;
    e14.setAll({ wheelX: "panX", wheelY: "zoomX" });
  ...
  async _createXYChart(e14, t6) {
    const { XYChartAm5: i11, XYCursorAm5: r7 } = await import("./xyChart-7XVLQPH7.js"), { root: a7, mediaInfo: o5 } = e14, { type: s12 } = o5, n13 = o5?.altText || o5?.title || "", l5 = a7.container.children.push(i11.new(a7, { ariaLabel: n13, focusable: true, panX: true, panY: true }));
    l5.set("cursor", r7.new(a7, {})), "column-chart" === s12 && await this._createColumnChart(l5, e14, t6), "bar-chart" === s12 && await this._createBarChart(l5, e14, t6), "line-chart" === s12 && await this._createLineChart(l5, e14, t6), l5.root.dom.classList.toggle(M3.mediaChartRendered, true);
  }
...
function f4({ layer: e14, aggregatedFeatures: r7, interceptor: a7 }) {
  ...
  return new Xe({ fields: n13, objectIdField: s12, geometryType: o5, spatialReference: i11, displayField: c14, interceptor: a7, ..."feature" === e14.type ? { templates: e14.templates, typeIdField: e14.typeIdField, types: e14.types } : null, source: r7 });
}
function g2(e14) {
...
async function x5(e14, r7, t6, a7, n13) {
  let s12 = null;
  if (n13.has("$aggregatedfeatures")) {
    const n14 = await y6({ graphic: e14, view: r7, options: t6 }), o5 = e14.sourceLayer || e14.layer;
...
async function h6(e14, { graphic: r7, map: t6, location: a7, view: n13, options: s12, interceptor: o5, arcadeExecutor: i11 }) {
  switch (e14) {
    case "popup":
    ...
    case "popup-feature-reduction": {
      ...
      return await x5(r7, n13, s12, o5, e15);
    }
    case "popup-voxel":
...
async function $3({ expressionInfo: e14, arcade: { executor: r7, syntaxUtils: t6 }, graphic: a7 }) {
  const n13 = e14?.expression;
  if (!n13) return null;
  const s12 = g2(a7), o5 = r7.createArcadeProfile(s12);
  let c14;
  try {
    c14 = await r7.createArcadeExecutor(n13, o5);
  } catch (u10) {
    return i8().error("arcade-executor-error", { error: u10, expressionInfo: e14 }), null;
  }
  const p10 = /* @__PURE__ */ new Set();
  return c14.variablesUsed.includes("$view") && (t6.scriptUsesViewProperties(c14.syntaxTree, ["scale"]) && p10.add("view-scale"), t6.scriptUsesViewProperties(c14.syntaxTree, ["timeProperties"]) && p10.add("view-time-extent")), { dependencies: p10, async evaluate({ graphic: r8, interceptor: t7, location: a8, map: n14, options: o6, spatialReference: p11, view: l5 }) {
    const d10 = await h6(s12, { graphic: r8, map: n14, location: a8, view: l5, options: o6, interceptor: t7, arcadeExecutor: c14 }), y10 = { abortSignal: o6?.signal ?? void 0, interceptor: t7 ?? void 0, rawOutput: true, spatialReference: p11 ?? void 0, timeZone: l5?.timeZone, console(...e15) {
      i8().info(...e15);
    } };
    try {
      return await c14.executeAsync(d10.vars, y10);
    } catch (u10) {
...
async function b5(e14, r7) {
  if (!e14?.length) return { dependencies: /* @__PURE__ */ new Set(), expressions: /* @__PURE__ */ new Map() };
  const t6 = await l4(), a7 = /* @__PURE__ */ new Set(), n13 = /* @__PURE__ */ new Map();
  for (const s12 of e14) {
    const e15 = await $3({ expressionInfo: s12, arcade: t6, graphic: r7 });
...
var g3 = class extends b2 {
  ...
  _startCompile() {
    this._evaluateTask = e(this._evaluateTask), this._compileTask = e(this._compileTask), this._compileTask = d2((async (t6) => {
      ...
      const s12 = await l4();
      s2(t6);
      const i11 = await $3({ expressionInfo: e14, arcade: s12, graphic: o5 });
      return s2(t6), i11;
    }));
  }
  _startEvaluate(t6) {
    this._evaluateTask = e(this._evaluateTask), this._evaluateTask = d2((async (e14) => {
      ...
      const { interceptor: s12, spatialReference: i11, map: r7, location: a7, view: l5 } = this, p10 = await t6.evaluate({ graphic: o5, interceptor: s12, location: a7, map: r7, options: { signal: e14 }, spatialReference: i11, view: l5 });
      s2(e14);
      const c14 = p10;
      if (!c14 || "esri.arcade.Dictionary" !== c14.declaredClass) return null;
      const m6 = await c14.castAsJsonAsync(e14);
      s2(e14);
...
var g4 = class extends O {
  ...
  loadDependencies() {
    return c3({ loader: () => import("./calcite-loader-GBIWPGQS.js") });
  }
  destroy() {
...
var _4 = class extends a3.ClonableMixin(n3.IdentifiableMixin(b2)) {
  ...
  async _queryFeatureCount() {
    ...
    if ("subtype-group" === t6?.type && !l5) {
      if (this._set("featureCount", 0), this._destroyRelatedFeatureViewModels(), this.featurePage = 1, this.relatedFeatures.destroyAll(), s12 && null != u10) {
        const { default: e15 } = await import("./uniqueValues-XRP432D6.js"), { uniqueValueInfos: l6 } = await e15({ layer: t6, sqlWhere: `${s12} = '${u10}'`, field: t6.subtypeField, signal: r7?.signal }), a8 = l6.map((({ count: e16, value: r8 }) => {
    ...
    const { historicMoment: y10, gdbVersion: h8 } = e14, c14 = new c5({ cacheHint: d10, gdbVersion: h8, historicMoment: y10, relationshipId: n13, returnGeometry: false, objectIds: [i11], where: this._getRelationshipWhereClause(t6) }), g8 = await e14.queryRelatedFeaturesCount(c14, { signal: r7?.signal });
  ...
  async _queryPage() {
    ...
    !r7 || t6 < 2 || !l5 || "subtype-group" === this.relatedLayer?.type && !this.activeCategory || e14.addMany(await this._queryRelatedFeatures({ signal: o5?.signal }));
  }
...
var M4 = b7 = class extends O {
  ...
  loadDependencies() {
    return c3({ chip: () => import("./calcite-chip-LGEUZARV.js"), icon: () => import("./calcite-icon-5GLXDGPE.js"), list: () => import("./calcite-list-ZCUE6QLI.js"), "list-item": () => import("./calcite-list-item-PQHIDJBB.js"), loader: () => import("./calcite-loader-GBIWPGQS.js"), notice: () => import("./calcite-notice-HNGSCYOY.js") });
  }
  destroy() {
  ...
  async _selectRecord(e14) {
    ...
    const { default: i11 } = await import("./Feature-J5AXHJTB.js");
  ...
  async _handleRelatedFeatureObserverChange() {
    ...
    await A(0), this._relatedFeatureIntersectionObserverNode && "ready" === e14 && t6 && this._relatedFeatureIntersectionObserver.observe(this._relatedFeatureIntersectionObserverNode);
  }
...
var v8 = class extends O {
  ...
  loadDependencies() {
    return c3({ icon: () => import("./calcite-icon-5GLXDGPE.js"), list: () => import("./calcite-list-ZCUE6QLI.js"), "list-item": () => import("./calcite-list-item-PQHIDJBB.js"), loader: () => import("./calcite-loader-GBIWPGQS.js"), notice: () => import("./calcite-notice-HNGSCYOY.js") });
  }
  destroy() {
...
var ne2 = (_a = class extends n3.IdentifiableMixin(b2) {
  ...
  async updateGeometry() {
    ...
    const r7 = [o5];
    if (!e14.geometry) {
      const s13 = await fe({ layer: i11, graphic: e14, outFields: [], objectIds: r7, returnGeometry: true, spatialReference: t6 }), o6 = s13?.geometry;
      o6 && (e14.geometry = o6);
    }
  }
  _clear() {
  ...
  _graphicChanged() {
    this._evaluateExpressionAttributesTask = e(this._evaluateExpressionAttributesTask), this._graphicChangedTask = e(this._graphicChangedTask), this._graphicChangedTask = d2((async (e14) => {
      ...
      try {
        ...
        await de({ graphic: t6, popupTemplate: s12, layer: i11, spatialReference: o5 }, { signal: e14 });
        const [{ value: r7 }, { value: a7 }] = await y([this._getContent(), this._getTitle()]), [, { value: n13 }] = await y([this._checkForRelatedFeatures({ signal: e14 }), b5(s12?.expressionInfos, t6)]);
  ...
  _compileRelationship(e14, t6) {
    ...
    if (!J(n13)) return;
    const c14 = new _4({ displayCount: i11, graphic: l5, orderByFields: s12, relationshipId: o5, layer: n13, map: p10, ...this._compileTitleAndDesc({ title: r7, description: a7 }) });
  ...
  async _setUpUtilityNetworkAssociationsViewModels(e14, t6, i11) {
    const { view: s12, spatialReference: o5, timeZone: r7 } = this;
    e14.forEach(((i12, s13) => {
      const o6 = t6.get(s13);
      o6 ? i12.forEach(((t7) => {
  ...
  _compileUtilityNetworkAssociation(e14, t6) {
    ...
    if (!K(a7)) return;
    const p10 = new v2({ graphic: n13, displayCount: i11, associationTypes: r7, layer: a7, map: l5, ...this._compileTitleAndDesc({ title: s12, description: o5 }) });
  ...
  _compileAttachments(e14, t6) {
    ...
    return this.contentViewModels[t6] = new s8({ graphic: i11, orderByFields: r7, ...this._compileTitleAndDesc({ title: o5, description: s12 }) }), e14;
  }
  ...
  _createFieldsVMParams(e14, t6) {
    const i11 = this._effectivePopupTemplate, s12 = this.formattedAttributes, o5 = { ...s12?.global, ...s12?.content[t6] }, r7 = e14?.fieldInfos || i11?.fieldInfos, a7 = r7?.filter((({ fieldName: e15 }) => !!e15 && (E(e15) || pe(e15) || o5.hasOwnProperty(e15)))), n13 = i11?.expressionInfos, { description: l5, title: p10 } = e14;
    return { attributes: o5, expressionInfos: n13, fieldInfos: a7, ...this._compileTitleAndDesc({ title: p10, description: l5 }) };
  }
  ...
  _createMediaVMParams(e14, t6) {
    ...
    return { abilities: { chartAnimation: i11.chartAnimation }, activeMediaInfoIndex: e14.activeMediaInfoIndex || 0, attributes: c14, isAggregate: s12?.isAggregate, layer: n13, fieldInfoMap: o5, formattedAttributes: { ...p10?.global, ...p10?.content[t6] }, expressionAttributes: l5, mediaInfos: h8, popupTemplate: r7, relatedInfos: a7, ...this._compileTitleAndDesc({ title: u10, description: d10 }) };
  }
  ...
  _evaluateExpressionAttributes({ title: e14, content: t6, expressionInfos: i11 }) {
    this._evaluateExpressionAttributesTask = e(this._evaluateExpressionAttributesTask), this._evaluateExpressionAttributesTask = d2((async (s12) => {
      ...
      try {
        ...
        if (null != i11) {
          ...
          l5 = Object.fromEntries(await Promise.all(e15)), s2(s12);
        }
        this._expressionAttributes = l5, this._graphicExpressionAttributes = { ...o5.attributes, ...l5 }, this._set("formattedAttributes", this._createFormattedAttributes(t6)), this._set("title", this._compileTitle(e14)), this._set("lastEditInfo", this._compileLastEditInfo() || null), this._set("content", this._compileContent(t6) || null);
      } catch (c14) {
  ...
  _createMediaFormattedAttributes({ contentElement: e14, contentElementIndex: t6, formattedAttributes: i11 }) {
    ...
    i11.content[t6] = se({ fieldInfos: s12?.fieldInfos, graphic: o5, attributes: { ...l5, ...e14.attributes }, layer: a7, fieldInfoMap: n13, relatedInfos: r7, timeZone: p10 });
  }
  _createFieldsFormattedAttributes({ contentElement: e14, contentElementIndex: t6, formattedAttributes: i11 }) {
    if (e14.fieldInfos) {
      ...
      i11.content[t6] = se({ fieldInfos: e14.fieldInfos, graphic: s12, attributes: { ...n13, ...e14.attributes }, layer: r7, fieldInfoMap: a7, relatedInfos: o5, timeZone: l5 });
    }
  }
...
var F8 = class extends n12(O) {
  constructor(e14, t6) {
    super(e14, t6), this._contentWidgets = [], this.flowType = "feature", this.flowItems = null, this.headingLevel = 2, this.messages = null, this.messagesCommon = null, this.visibleElements = { ...b8 }, this.viewModel = new ne2();
  }
  initialize() {
    this.addHandles(l((() => this.viewModel?.contentViewModels), (() => this._setupContentWidgets()), h2));
  }
  loadDependencies() {
    return c3({ notice: () => import("./calcite-notice-HNGSCYOY.js"), loader: () => import("./calcite-loader-GBIWPGQS.js") });
  }
  destroy() {
    ...
    if (Array.isArray(n13)) n13.forEach(((n14, r7) => {
      ...
      if ("utility-network-associations" === n14.type) {
        const e15 = async (e16) => {
          ...
          const { default: l5 } = await import("./FeatureUtilityNetworkAssociationList-WPM6W3HV.js"), d10 = new l5({ viewModel: n16, parentFeatureViewModel: i11, listType: o6, title: r8, featureVisibleElements: t6, description: i11.title, flowItems: s12 });
          s12.push(d10);
...
//# sourceMappingURL=chunk-K4KZXP5S.js.map
