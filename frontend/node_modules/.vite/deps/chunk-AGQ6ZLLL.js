import {
  a as a2
} from "./chunk-QYQAGD6G.js";
import {
  s as s3,
  t
} from "./chunk-Y6UIOJ4V.js";
import {
  e,
  i as i3,
  p,
  p2
} from "./chunk-QHWOGFQV.js";
import {
  g
  ...
  switch (e15) {
    ...
    case "feature-record-set-layer":
      ...
      if ("layerDefinition" in t22) {
        const e16 = new (0, (await import("./FeatureLayer-6AT5WKG5.js")).default)(), { layerDefinition: a9, featureSet: n7 } = t22;
...
async function O(e15) {
  const r7 = t2.fromJSON(e15.dataType), { paramName: t22 } = e15, a9 = j(r7) ? await J(r7, e15.value) : await N(r7, e15.value);
...
var g3 = (_a = class extends l {
  ...
  async cancelJob(e15) {
    const { jobId: t22, sourceUrl: s10 } = this, { path: a9 } = f2(s10), c9 = { ...this.requestOptions, ...e15, query: { f: "json" } }, n7 = `${a9}/jobs/${t22}/cancel`, { data: u5 } = await H(n7, c9), { messages: b4, jobStatus: m10, progress: j3 } = p5.fromJSON(u5);
  ...
  async checkJobStatus(e15) {
    const { path: t22 } = f2(this.sourceUrl), s10 = { ...this.requestOptions, ...e15, query: { f: "json" } }, r7 = `${t22}/jobs/${this.jobId}`, { data: i12 } = await H(r7, s10), { messages: a9, jobStatus: c9, progress: n7 } = p5.fromJSON(i12);
    return this.set({ messages: a9, jobStatus: c9, progress: n7 }), this;
  }
  async fetchResultData(e15, t22, s10) {
    t22 = i4.from(t22 || {});
    const { returnColumnName: r7, returnFeatureCollection: i12, returnM: a9, returnZ: c9, outSpatialReference: n7 } = t22, { path: j3 } = f2(this.sourceUrl), p17 = R2({ returnColumnName: r7 || null, returnFeatureCollection: i12 || null, returnM: a9 || null, returnZ: c9 || null, outSR: n7, returnType: "data", f: "json" }, null), h8 = { ...this.requestOptions, ...s10, query: p17 }, d4 = `${j3}/jobs/${this.jobId}/results/${e15}`, { data: g9 } = await H(d4, h8);
    return O(g9);
  }
  async fetchResultImage(e15, t22, s10) {
    const { path: r7 } = f2(this.sourceUrl), i12 = { ...t22.toJSON(), f: "json" }, a9 = R2(i12), c9 = { ...this.requestOptions, ...s10, query: a9 }, n7 = `${r7}/jobs/${this.jobId}/results/${e15}`, { data: u5 } = await H(n7, c9);
    return O(u5);
  }
  async fetchResultMapImageLayer() {
    ...
    return new (0, (await import("./MapImageLayer-246TAMZT.js")).default)({ url: t22 });
  }
  async waitForJobCompletion(e15 = {}) {
...
async function o4(s10) {
  if (s10) {
    const { default: s11 } = await import("./arcgis-knowledge-client-core-simd-3F5UFM4M.js").then(((e15) => e15.a));
    return s11({ locateFile: (s12) => n(t7 + s12) });
  }
  const { default: n7 } = await import("./arcgis-knowledge-client-core-ZWAZGJTH.js").then(((e15) => e15.a));
...
var J2 = { fetchKnowledgeGraph: async (e15) => {
  const t22 = new p8({ url: e15 }), r7 = [];
  return r7.push(he(t22)), r7.push(we(t22)), await Promise.all(r7), t22;
}, refreshDataModel: async (e15) => {
  e15.dataModel = await Ye(e15);
}, refreshServiceDefinition: async (e15) => {
  const r7 = (await H(e15.url, { query: { f: "json" } })).data;
...
}, executeFindPathsAsynchronous: async (e15, t22) => {
  ...
  return await ke(`${n7}${d4}`, { in_knowledge_graph_url: e15.inKnowledgeGraphUrl, config_type: "STRING", config_string: e15.config.toJSON(), result_type: "STRING" }, {}, t22);
}, executeFindPaths: async (e15, t22) => {
  const a9 = e15.inKnowledgeGraphUrl.split("/rest/services");
  if (a9.length < 2) throw new s("knowledge-graph:invalid-tool-url", "The URL for the KG Service was not correctly formatted.  It should contain /rest/services/");
  ...
  return s10;
}, fetchAsynchronousFindPathsResultData: async (e15, t22) => (await e15.fetchResultData("out_results_string", null, t22)).value, executeQueryStreaming: async (e15, t22, a9) => {
  ...
  d4.data.body = await qe(t22, e15);
  const i12 = await _e(d4.data.url, d4.data);
  if (e15.dataModel) {
    const t23 = await Ve(i12, e15.dataModel);
...
}, executeApplyEdits: async (e15, t22, a9) => {
  ...
  o6.data.body = await Te(t22, e15);
  return je(await _e(o6.data.url, o6.data));
}, executeAddNamedTypes: async (e15, t22, a9) => {
  ...
  await be(e15);
  const o6 = await Fe(n7, a9);
  o6.data.body = await ve(t22);
  const d4 = await _e(o6.data.url, o6.data), i12 = await Ue(d4);
  return i12.updatedKnowledgeGraph = await ue(e15.url), i12;
}, executeDeleteNamedType: async (e15, t22, a9) => {
  ...
  return i12.updatedKnowledgeGraph = await ue(e15.url), i12;
}, executeUpdateNamedType: async (e15, t22, a9, n7) => {
  ...
  d4.data.body = await Ae(a9, t22, e15.dataModel);
  const i12 = await _e(d4.data.url, d4.data), s10 = await Ke(i12);
  return s10.updatedKnowledgeGraph = await ue(e15.url), s10;
}, executeAddGraphProperties: async (e15, t22, a9, n7) => {
  ...
  return s10.updatedKnowledgeGraph = await ue(e15.url), s10;
}, executeDeleteGraphProperty: async (e15, t22, a9, n7) => {
  ...
  return s10.updatedKnowledgeGraph = await ue(e15.url), s10;
}, executeUpdateGraphProperty: async (e15, t22, a9, n7, o6) => {
  ...
  return p17.updatedKnowledgeGraph = await ue(e15.url), p17;
}, executeAddGraphFieldIndex: async (e15, t22, a9, n7) => {
  ...
  return s10.updatedKnowledgeGraph = await ue(e15.url), s10;
}, executeDeleteGraphFieldIndex: async (e15, t22, a9, n7) => {
  if (!t22) throw new s("knowledge-graph:no-arguments", "The operation to update search index in the data model contained missing named type");
  if (!a9?.length) throw new s("knowledge-graph:no-arguments", "The operation to update search index in the data model contained missing or empty field index values");
  ...
  return s10.updatedKnowledgeGraph = await ue(e15.url), s10;
}, executeUpdateSearchIndex: async (e15, t22, a9, n7) => {
  if (!t22) throw new s("knowledge-graph:no-arguments", "The operation to update search index in the data model contained missing named type");
  ...
  await be(e15);
  const d4 = await Fe(o6, n7);
  d4.data.body = await Ie(t22, a9);
  const i12 = await _e(d4.data.url, d4.data), s10 = await He(i12);
  return s10.updatedKnowledgeGraph = await ue(e15.url), s10;
}, executeQuery: async (e15, a9, n7) => {
  const o6 = `${e15.url}/graph/query`, d4 = await H(o6, { responseType: "array-buffer", query: { f: "pbf", openCypherQuery: a9.openCypherQuery, ...n7?.query }, signal: n7?.signal, timeout: n7?.timeout }), i12 = d4.getHeader?.("content-type"), p17 = d4.data;
  if (i12?.includes("application/x-protobuf")) {
    const t22 = new (await r3()).GraphQueryDecoder();
...
}, executeSearch: async (e15, a9, n7) => {
  const o6 = a9.typeCategoryFilter, d4 = `${e15.url}/graph/search`, i12 = await H(d4, { responseType: "array-buffer", query: { f: "pbf", searchQuery: `"${a9.searchQuery}"`, typeCategoryFilter: o6, ...n7?.query }, signal: n7?.signal, timeout: n7?.timeout }), p17 = i12.getHeader?.("content-type"), c9 = i12.data;
...
}, executeSearchStreaming: async (e15, t22, a9) => {
  const n7 = `${e15.url}/graph/search`;
  await be(e15);
  const o6 = await Fe(n7, a9);
  o6.data.body = await Ce(t22);
  const d4 = await _e(o6.data.url, o6.data);
  if (e15.dataModel) {
    const t23 = await Ve(d4, e15.dataModel);
    return new a5({ resultRowsStream: t23.readableStream, resultHeader: t23.resultHeader });
  }
  throw new s("knowledge-graph:undefined-data-model", "The KnowledgeGraph supplied did not have a data model");
}, fetchClientDataAtKeys: async (e15, t22, a9 = { ignoreCache: false }) => {
  ...
  const i12 = await r3(), s10 = t6(t22, n7, i12, a9.ignoreCache), p17 = await Fe(d4, a9.requestOptions);
  p17.data.body = s10;
  ...
  if (l5?.includes("application/x-protobuf")) {
    ...
    e16.deleteLater();
    const t23 = await c9.arrayBuffer();
...
}, fetchAllClientDataKeys: async (e15, a9) => {
  const n7 = `${e15.url}/clientData`, o6 = await H(n7, { responseType: "array-buffer", query: { f: "pbf" }, signal: a9?.signal, timeout: a9?.timeout }), d4 = o6.getHeader?.("content-type"), i12 = o6.data;
  if (d4?.includes("application/x-protobuf")) {
    const e16 = new (await r3()).ClientDataKeysResponseDecoder();
...
}, clearClientDataCache: () => z3.clear(), _fetchWrapper: async (e15, t22) => fetch(e15, t22), _submitJobWrapper: async (e15, t22, r7, a9) => s5(e15, t22, r7, a9), _esriRequestWrapper: async (e15, r7) => H(e15, r7) };
async function V(e15, t22, r7) {
  return J2.executeApplyEdits(e15, t22, r7);
}
async function Y(e15, t22, r7) {
  return J2.executeAddNamedTypes(e15, t22, r7);
}
async function X(e15, t22, r7) {
  return J2.executeDeleteNamedType(e15, t22, r7);
}
async function Z(e15, t22, r7, a9) {
  return J2.executeUpdateNamedType(e15, t22, r7, a9);
}
async function ee(e15, t22, r7, a9) {
  return J2.executeAddGraphProperties(e15, t22, r7, a9);
}
async function te(e15, t22, r7, a9) {
  return J2.executeDeleteGraphProperty(e15, t22, r7, a9);
}
async function re(e15, t22, r7, a9, n7) {
  return J2.executeUpdateGraphProperty(e15, t22, r7, a9, n7);
}
async function ae(e15, t22, r7, a9) {
  return J2.executeAddGraphFieldIndex(e15, t22, r7, a9);
}
async function ne(e15, t22, r7, a9) {
  return J2.executeDeleteGraphFieldIndex(e15, t22, r7, a9);
}
async function oe(e15, t22, r7, a9) {
  return J2.executeUpdateSearchIndex(e15, t22, r7, a9);
}
async function de(e15, t22, r7) {
  return J2.executeQuery(e15, t22, r7);
}
async function ie(e15, t22, r7) {
  return J2.executeQueryStreaming(e15, t22, r7);
}
async function se(e15, t22, r7) {
  return J2.executeSearch(e15, t22, r7);
}
async function pe(e15, t22, r7) {
...
async function Te(e15, t22) {
  if (t22.dataModel || await he(t22), !t22.dataModel) throw new s("knowledge-graph:data-model-undefined", "Encoding could not proceed because a data model was not provided and it could not be determined from the service");
  const a9 = await r3(), n7 = !!e15.options?.cascadeDelete, o6 = !!e15.options?.cascadeProvenanceDelete, d4 = new a9.GraphApplyEditsEncoder(a9.SpatialReferenceUtil.WGS84(), e15.options?.inputQuantizationParameters ? l3(e15.options?.inputQuantizationParameters) : a9.InputQuantizationUtil.WGS84_lossless());
...
async function ve(e15) {
  const t22 = await r3(), a9 = new t22.GraphNamedObjectTypeAddsRequestEncoder();
...
async function Pe(e15) {
  const t22 = await r3(), a9 = new t22.GraphPropertyAddsRequestEncoder();
...
async function Se(e15) {
  const t22 = new (await r3()).GraphPropertyDeleteRequestEncoder();
...
async function Re(e15) {
  const t22 = await r3(), a9 = new t22.GraphIndexAddsRequestEncoder();
  a9.deleteLater(), e15.forEach(((e16) => {
...
async function Ee(e15) {
  const t22 = new (await r3()).GraphIndexDeleteRequestEncoder();
...
async function qe(e15, t22) {
  ...
  if (e15.bindGeometryQuantizationParameters) y2(e15.bindGeometryQuantizationParameters, n7);
    ...
    if (t22.dataModel || await he(t22), 4326 !== t22.dataModel?.spatialReference?.wkid) throw new s("knowledge-graph:SR-quantization-mismatch", "If the DataModel indicates a coordinate system other than WGS84, inputQuantizationParameters must be provided to the query encoder");
...
async function Ce(e15) {
  const t22 = await r3(), a9 = new t22.GraphSearchRequestEncoder();
...
async function Fe(e15, r7) {
  return H(e15, { responseType: "native-request-init", method: "post", query: { f: "pbf", ...r7?.query }, body: "x", headers: { "Content-Type": "application/octet-stream" }, signal: r7?.signal, timeout: r7?.timeout });
}
async function Me(e15, t22, a9) {
  const n7 = e15.headers.get("content-type");
  if (n7?.includes("application/x-protobuf")) {
    const r7 = await e15.arrayBuffer(), n8 = new t22();
    try {
  ...
  throw new s("knowledge-graph:unexpected-server-response", "server returned an unexpected response", { responseType: n7, data: await e15.text() });
}
async function je(e15) {
  return Me(e15, (await r3()).GraphApplyEditsDecoder, r6);
}
async function Ue(e15) {
  return Me(e15, (await r3()).GraphNamedObjectTypeAddsResponseDecoder, p14);
}
async function Ne(e15) {
  return Me(e15, (await r3()).GraphNamedObjectTypeDeleteResponseDecoder, a7);
}
async function Ke(e15) {
  return Me(e15, (await r3()).GraphNamedObjectTypeUpdateResponseDecoder, i10);
}
async function Qe(e15) {
  return Me(e15, (await r3()).GraphPropertyAddsResponseDecoder, m8);
}
async function $e(e15) {
  return Me(e15, (await r3()).GraphPropertyDeleteResponseDecoder, f5);
}
async function Le(e15) {
  return Me(e15, (await r3()).GraphPropertyUpdateResponseDecoder, g6);
}
async function Oe(e15) {
  return Me(e15, (await r3()).GraphIndexAddsResponseDecoder, y4);
}
async function We(e15) {
  return Me(e15, (await r3()).GraphIndexDeleteResponseDecoder, R3);
}
async function He(e15) {
  return Me(e15, (await r3()).GraphUpdateSearchIndexResponseDecoder, h4);
}
var ze = 50;
function Be(e15) {
  ze = e15;
...
async function Ve(e15, t22) {
  ...
  if (e15.headers.get("content-length") && i.getLogger("esri.rest.knowledgeGraph.knowledgeGraphService").warnOnce("Found `Content-Length` header when expecting a streaming HTTP response! Please investigate whether all intermediate HTTP proxies and/or load balancers are configured such that they don't forcefully buffer the entire response before returning it to the client. A valid HTTP streaming response should use Chunked Transfer Encoding and not have a Content Length defined."), o6?.includes("application/x-protobuf")) {
    const o7 = e15.body?.getReader(), d4 = new (await r3()).GraphQueryDecoder();
    let i12, s10, c9;
    d4.deleteLater();
    ...
    const g9 = new ReadableStream({ pull: async function e16(l6) {
      if (!o7) {
        const e17 = new s("knowledge-graph:stream-decoding-error", "Error reading from stream - reader is undefined");
        throw c9(e17), e17;
      }
      const { done: w4, value: g10 } = h8 ? { done: false, value: null } : await o7.read().catch(((e17) => {
      ...
      try {
        ...
        return y6 && (h8 = null), !i12 && a9 && (i12 = a9, s10(a9), u5 = true), n7.length > 0 ? void l6.enqueue(n7) : await e16(l6);
      } catch (y6) {
...
async function Ye(e15) {
  const a9 = `${e15.url}/dataModel/queryDataModel`, n7 = await H(a9, { responseType: "array-buffer", query: { f: "pbf" } }), o6 = n7.getHeader?.("content-type"), d4 = n7.data;
  if (o6?.includes("application/x-protobuf")) {
    const e16 = (await r3()).decode_data_model_from_protocol_buffer(new Uint8Array(d4));
...
//# sourceMappingURL=chunk-AGQ6ZLLL.js.map
