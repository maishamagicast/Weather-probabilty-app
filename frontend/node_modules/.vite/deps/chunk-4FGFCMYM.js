...
async function f4(u8, i5, f5) {
  ...
  return l5.path += "/identify", R(c3).then(((e2) => {
    const t = o3(i5, { geometry: e2?.[0] }), u9 = u2({ ...l5.query, f: "json", ...t }), a5 = s3(u9, f5);
...
var P = class extends b {
  ...
  async _fetchPopupFeaturesUsingQueries(e2, t, r4) {
    const { layerView: { floors: i5, timeExtent: o4 } } = this, a5 = t.map((async ({ sublayer: t2, popupTemplate: s4 }) => {
      ...
      const a6 = t2.createQuery(), n3 = o2({ renderer: t2.renderer, pointerType: r4?.pointerType }), c3 = this.createFetchPopupFeaturesQueryGeometry(e2, n3), u8 = /* @__PURE__ */ new Set(), [h] = await Promise.all([n2(t2, s4), t2.renderer?.collectRequiredFields(u8, t2.fieldsIndex)]);
...
//# sourceMappingURL=chunk-4FGFCMYM.js.map
