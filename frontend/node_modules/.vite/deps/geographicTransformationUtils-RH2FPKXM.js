...
async function m() {
  if (!p()) {
    const [t, e, r2, p2] = await Promise.all([import("./Envelope2D-SZNQNMVA.js"), import("./ProjectionTransformation-RMC77OPG.js").then(((n) => n.aK)).then((({ queryTransformationList: n }) => n)), import("./ProjectionTransformation-RMC77OPG.js").then(((n) => n.aG)).then((({ injectPe: n }) => n)), import("./apiConverter-PYGNI7LB.js"), _()]);
...
//# sourceMappingURL=geographicTransformationUtils-RH2FPKXM.js.map
