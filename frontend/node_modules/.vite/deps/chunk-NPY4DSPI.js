...
async function Y(e5, t6) {
  ...
  if (t6.cache) s5 = await t6.cache.loadGLTF(o5.url, t6, !!t6.usePBR);
    ...
    const { loadGLTF: e6 } = await import("./loader-FJ4KF3KS.js");
    s5 = await e6(new n7(t6.streamDataRequester), o5.url, t6, t6.usePBR);
  }
  ...
  const l3 = !!t6.usePBR, a6 = s5.meta.isEsriSymbolResource ? { usePBR: l3, isSchematic: false, treeRendering: n11, mrrFactors: s2 } : { usePBR: l3, isSchematic: false, treeRendering: false, mrrFactors: t3 }, u3 = { ...t6.materialParameters, treeRendering: n11 }, { engineResources: c2, referenceBoundingBox: m } = ee(s5, a6, u3, t6, o5.specifiedLodIndex, n11);
      ...
      const e5 = (e6, t8 = false, o7 = false) => {
        if (null != e6 && !l3.has(e6)) {
          ...
          if (s6) {
            ...
            l3.set(e6, new L(n9(r5) ? r5.data : r5, { ...s6.parameters, preMultiplyAlpha: !n9(r5) && o7, encoding: n9(r5) ? r5.encoding : void 0, compressionOptions: i7 }));
          }
        }
      }, t7 = h2 !== i5.Opaque && !c2;
...
//# sourceMappingURL=chunk-NPY4DSPI.js.map
