...
async function H2(e3, r4) {
  ...
  s4 || t2 || (e3 = K(e3));
  const o2 = { url: e3, requestOptions: { ...r4 } }, a6 = (e4) => ({ data: e4, getAllHeaders: B, getHeader: B, httpStatus: 200, requestOptions: o2.requestOptions, url: o2.url }), i3 = N(e3, _2.internalInterceptors);
  if (i3) {
...
async function G2() {
  has("host-webworker") && (!M2 && globalThis.invokeStaticMessage ? M2 = await import("./request-VPQ2WFXE.js") : R2 = true);
}
async function J() {
  s3 || await import("./IdentityManager-65PU3PUU.js");
}
...
async function V2(e3) {
  ...
  if (!i3) {
    ...
    if (c3) {
      const e4 = P(t2);
      u5 = e4.path, !p4 && u5.length + 1 + l3 > _2.maxUrlLength && (p4 = true), e4.query && (a6 = { ...e4.query, ...a6 });
    }
    ...
    e3.withCredentials && (n2.credentials = "include", w3(t2) && await L(p4 ? Ht(t2, a6) : t2)), s4 = g3(t2);
  }
...
async function te(e3) {
  ...
  if (!r4) return se(e3);
  const { QueueProcessor: t2 } = await import("./QueueProcessor-73YFMSIM.js"), s4 = u(re, r4.origin, (() => {
...
//# sourceMappingURL=chunk-POWGZO3T.js.map
