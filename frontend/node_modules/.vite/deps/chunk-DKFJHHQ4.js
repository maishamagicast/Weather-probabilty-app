...
var a3 = { async request(a7, s6) {
  ...
  const i4 = await H(a7.url, r3), o = { data: i4.data, httpStatus: i4.httpStatus, ssl: i4.ssl };
...
function b2() {
  ...
  const n3 = s.workers.loaderConfig, i4 = r2({ baseUrl: n3?.baseUrl, locale: i2(), has: { "csp-restrictions": 1, "dojo-test-sniff": 0, "host-webworker": 1, ...n3?.has }, map: { ...n3?.map }, paths: { ...n3?.paths }, packages: n3?.packages || [] }), l3 = { buildDate: f, fullVersion: r, revision: a };
...
async function f3(r3, t2) {
  const n3 = new c(), { registryTarget: i4, ...s6 } = t2;
...
//# sourceMappingURL=chunk-DKFJHHQ4.js.map
