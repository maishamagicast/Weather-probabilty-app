...
var f = class extends b2 {
  ...
  _onNewJob() {
    ...
    const i2 = t.abortController.signal, r2 = { responseType: "array-buffer", signal: i2, query: { ...t.customParameters, token: t.apiKey } }, a2 = { id: e2.jobId, inputs: [], jobDescJson: e2.desc.slice(), isMissingResourceCase: false }, n2 = new URL(t.layerView.layer.url), o = this._getRequestPromises(e2.urls, r2, n2);
...
//# sourceMappingURL=Lyr3DWasmPerSceneView-ZKGIHUSO.js.map
