...
var S2 = class extends e4 {
  ...
  async updateTexture({ context: t2, painter: e5 }) {
    ...
    try {
      if (null != this._uploadStatus) {
        ...
        await a3.enqueueTextureUpdate({ data: s, texture: u, width: h2, height: o2 }, r3), i2.resolve(), this._uploadStatus = null;
...
//# sourceMappingURL=chunk-VOZCHSVQ.js.map
