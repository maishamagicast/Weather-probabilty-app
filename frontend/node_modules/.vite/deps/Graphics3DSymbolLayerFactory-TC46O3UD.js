import {
  V as V5,
  d as d7
} from "./chunk-PM6EG6SL.js";
import {
  T as T3,
  a as a25
} from "./chunk-QIW5XQQ6.js";
import {
  S as S5
} from "./chunk-7LCXWSXL.js";
...
import {
  s as s19
} from "./chunk-4S4P25QU.js";
import {
  a as a21,
  p as p12,
  s as s18
} from "./chunk-7ABIZ3WR.js";
...
var _ue = class _ue extends y7 {
  ...
  async _prepareResourcesCIM(e37, t29, r29) {
    const { OverrideHelper: i18 } = await import("./OverrideHelper-7WYHDE2S.js");
    if (this._overrideHelperClass = i18, this._cimData = t29, !this._context.sharedResources.cimSymbolRasterizer) {
      const e38 = (await import("./CIMSymbolRasterizer-SZGAUELX.js")).CIMSymbolRasterizer;
    ...
    if (this._arcadeInfo = { spatialReference: h23, fields: c25, geometryType: "esriGeometryPoint" }, a33?.primitiveOverrides && o28.push(i18.createRenderExpressions(a33.primitiveOverrides, this._arcadeInfo)), o28.length > 0 && (await Promise.all(o28), s2(r29)), this._context.renderer && "dictionary" === this._context.renderer.type && this._context.renderer.scaleExpression) {
      ...
      if (e38.scaleExpression) {
        const t30 = e38.scaleExpression, r30 = await h4(t30, this._context.layer.spatialReference), { default: i19 } = await import("./callExpressionWithFeature-56UV4HJP.js"), s27 = new Z2(c25);
...
var S6 = class extends g8 {
  constructor(e37, t29) {
    super(e37, t29, new t16(k6, (() => import("./LineMarker.glsl-5CWHBS7C.js"))), W3);
  }
...
var g16 = class extends g8 {
  constructor(r29, e37) {
    super(r29, e37, new t16(V5, (() => import("./Path.glsl-7UWXNJ6J.js"))), L8);
  }
...
var S11 = class extends g8 {
  constructor(e37, r29) {
    super(e37, r29, new t16(T3, (() => import("./Pattern.glsl-IQH3TE5U.js"))), e22() ? E15 : j9);
  }
...
var h21 = class extends g8 {
  constructor(r29, e37) {
    super(r29, e37, new t16(S5, (() => import("./WaterSurface.glsl-N3XKO2TZ.js"))));
  }
  initializePipeline(e37) {
...
//# sourceMappingURL=Graphics3DSymbolLayerFactory-TC46O3UD.js.map
