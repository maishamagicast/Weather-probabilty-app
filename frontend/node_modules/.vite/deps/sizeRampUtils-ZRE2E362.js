import {
  g
} from "./chunk-66D3QJJH.js";
import "./chunk-HD32LD5D.js";
import "./chunk-R62BLGYS.js";
import "./chunk-S3VC5TBM.js";
import "./chunk-AAOJ7S5D.js";
import {
  c,
  i,
  l as l2,
...
async function H(e2, t2, o, i3) {
  const n2 = (await import("./visualVariableUtils-IGLTDDNB.js")).getSizeRangeAtScale(e2, o, i3), r2 = n2 && O(n2);
  if (!n2 || !r2) return;
...
async function G2(e2, t2, l3, o, i3) {
  const { getSize: n2 } = await import("./visualVariableUtils-IGLTDDNB.js");
...
export {
  L2 as getRampStops,
  T as getReferenceSizeSymbol,
  w2 as realWorldMaxSize,
  S3 as realWorldMinSize
};
//# sourceMappingURL=sizeRampUtils-ZRE2E362.js.map
