...
function f(o6, i2) {
  ...
  switch (o6.type) {
    case "solid":
      return g({ color: s, size: l2, extensionLength: c2, ...i2 });
    case "sketch":
      return p({ color: s, size: l2, extensionLength: c2, ...i2 });
    default:
      return;
  }
}
function g(e7) {
  return { ...m2, ...e7, type: u3.Solid };
}
function p(e7) {
  return { ...d, ...e7, type: u3.Sketch };
}
...
//# sourceMappingURL=chunk-QYDHMHNZ.js.map
