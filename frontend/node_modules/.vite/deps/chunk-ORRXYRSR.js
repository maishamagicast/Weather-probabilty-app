  ...
  let E = class extends j2 {
    ...
    async loadFromPortal(e, t) {
      if (this.portalItem?.id) try {
        const { load: r3 } = await import("./layersLoader-XYUBGHQ3.js");
        return s4(t), await r3({ instance: this, supportedTypes: e.supportedTypes, validateItem: e.validateItem, supportsData: e.supportsData, layerModuleTypeMap: e.layerModuleTypeMap, populateGroupLayer: e.populateGroupLayer }, t);
      } catch (r3) {
  ...
  ${r3}`), r3;
    ...
    async _fetchUserPrivileges(e, t) {
      ...
      try {
        ...
        l = await s3?.getCredential(`${a3}/sharing`, { prompt: false, signal: e2 });
      } catch (m2) {
        a(m2);
      }
...
//# sourceMappingURL=chunk-ORRXYRSR.js.map
