...
function m(a, e2, m2) {
  ...
  let o2 = c2, s2 = c2;
  e2 && m2 && (p2 = L2 = o2 = s2 = 0);
  return [{ type: "path", path: [{ command: "M", values: [o2, n2] }, { command: "L", values: [m2 ? o2 : 0.875 * o2, n2] }, { command: "L", values: [m2 ? p2 - 0.5 * o2 : l3, L2 - 0.5 * s2] }, { command: "L", values: [p2 - 0.5 * o2, L2 - 0.5 * s2] }, { command: "Z", values: [] }] }, { type: "path", path: [{ command: "M", values: [o2, n2] }, { command: "L", values: [o2, e2 ? n2 : 0.125 * s2] }, { command: "L", values: [p2 - 0.5 * o2, e2 ? L2 - 0.5 * s2 : s2] }, { command: "L", values: [p2 - 0.5 * o2, L2 - 0.5 * s2] }, { command: "Z", values: [] }] }, { type: "path", path: [{ command: "M", values: [p2 - 0.5 * o2, L2 - 0.5 * s2] }, { command: "L", values: [m2 ? p2 - 0.5 * o2 : l3, L2 - 0.5 * s2] }, { command: "L", values: [m2 ? p2 - 0.5 * o2 : l3, e2 ? L2 - 0.5 * s2 : s2] }, { command: "L", values: [p2 - 0.5 * o2, e2 ? L2 - 0.5 * s2 : s2] }, { command: "Z", values: [] }] }];
}
function c(a) {
...
function L(a, e2) {
  ...
  const L2 = 0, n2 = 0, l3 = e2 ? 0.35 * m2 : 0.5 * m2;
  return [{ type: "path", path: [{ command: "M", values: [0.5 * m2, L2] }, { command: "L", values: [m2, 0.5 * l3] }, { command: "L", values: [0.5 * m2, l3] }, { command: "L", values: [n2, 0.5 * l3] }, { command: "Z", values: [] }] }, { type: "path", path: [{ command: "M", values: [L2, 0.5 * l3] }, { command: "L", values: [0.5 * m2, l3] }, { command: "L", values: [0.5 * m2, c2] }, { command: "L", values: [n2, c2 - 0.5 * l3] }, { command: "Z", values: [] }] }, { type: "path", path: [{ command: "M", values: [0.5 * m2, l3] }, { command: "L", values: [0.5 * m2, c2] }, { command: "L", values: [m2, c2 - 0.5 * l3] }, { command: "L", values: [m2, 0.5 * l3] }, { command: "Z", values: [] }] }];
}
function n(a, e2) {
  let m2 = e2 ? t.tallSymbolWidth : a;
  const c2 = a, p2 = e2 ? 4 : 6;
  m2 <= t.size ? m2 -= 0.5 * p2 : m2 -= p2;
  const L2 = 0.5 * m2, n2 = 0.15 * m2, l3 = 0, o2 = c2 - n2;
  return [{ type: "ellipse", cx: 0.5 * m2, cy: o2, rx: L2, ry: n2 }, { type: "path", path: [{ command: "M", values: [l3, n2] }, { command: "L", values: [l3, o2] }, { command: "L", values: [m2, o2] }, { command: "L", values: [m2, n2] }, { command: "Z", values: [] }] }, { type: "ellipse", cx: 0.5 * m2, cy: n2, rx: L2, ry: n2 }];
}
function l2(a, e2) {
  let m2 = e2 ? t.tallSymbolWidth : a;
  const c2 = a, p2 = e2 ? 4 : 6;
...
function s(a) {
  ...
  const m2 = a, c2 = 4;
  e2 < t.size ? e2 -= 0.5 * c2 : e2 -= c2;
  const p2 = 0, L2 = 0, n2 = e2, l3 = m2, o2 = Math.floor(a / 10) - 1 || 1;
  return [{ type: "path", path: [{ command: "M", values: [0.45 * n2, p2] }, { command: "L", values: [n2, 0.5 * l3 - o2] }, { command: "L", values: [0.45 * n2 - o2, 0.5 * l3 + o2] }, { command: "Z", values: [] }] }, { type: "path", path: [{ command: "M", values: [0.45 * n2, p2] }, { command: "L", values: [0.45 * n2 - o2, 0.5 * l3 + o2] }, { command: "L", values: [L2, 0.5 * l3 - o2] }, { command: "Z", values: [] }] }, { type: "path", path: [{ command: "M", values: [L2, 0.5 * l3 - o2] }, { command: "L", values: [0.45 * n2 - o2, 0.5 * l3 + o2] }, { command: "L", values: [0.45 * n2, m2] }, { command: "Z", values: [] }] }, { type: "path", path: [{ command: "M", values: [0.45 * n2, m2] }, { command: "L", values: [n2, 0.5 * l3 - o2] }, { command: "L", values: [0.45 * n2 - o2, 0.5 * l3 + o2] }, { command: "Z", values: [] }] }];
}
function u(a) {
  const e2 = a, m2 = 2;
  let c2 = a;
...
function d(t2, e2) {
  if (null == t2) return new l();
  if ("type" in t2 && ("linear" === t2.type || "pattern" === t2.type)) return t2;
  const m2 = new l(t2);
  return new l([h(m2.r, e2), h(m2.g, e2), h(m2.b, e2), m2.a]);
}
...
//# sourceMappingURL=chunk-R62BLGYS.js.map
