...
var n = { exports: {} };
function o2() {
  return t || (t = 1, e2 = n, o3 = "undefined" != typeof document ? document.currentScript?.src : void 0, a2 = async function(e3 = {}) {
    ...
    "undefined" != typeof document && document.currentScript && (c = document.currentScript.src), o3 && (c = o3), c = c.startsWith("blob:") ? "" : c.slice(0, c.replace(/[?#].*/, "").lastIndexOf("/") + 1), a3 = async (r) => {
      var e4 = await fetch(r, { credentials: "same-origin" });
    ...
    async function I(r, e4) {
      try {
        var t3 = await W(r);
        return await WebAssembly.instantiate(t3, e4);
      } catch (n3) {
        P(`failed to asynchronously prepare wasm: ${n3}`), B(n3);
      }
    }
    async function L(r, e4, t3) {
    ...
    }, msync: (r, e4, t3, n3, o4) => (wr.stream_ops.write(r, e4, 0, n3, t3, false), 0) } }, yr = async (r) => {
      var e4 = await a3(r);
      return new Uint8Array(e4);
    }, gr = (r, e4, t3, n3, o4, a4) => {
    ...
    var Xt = { i: er, w: Dr, L: $r, M: Tr, N: Cr, U: Lr, y: Jr, S: Zr, Q: se, x: ue, q: Ae, c: Pe, b: Se, R: $e, p: Be, V: Oe, k: ze, T: We, P: Ie, E: Le, X: He, z: Ye, a: te, Y: Je, A: et, m: tt, g: nt, B: ot, h: at, r: it, W: st, l: lt, G: ut, F: mt, I: wt, J: yt, O: bt, u: kt, K: At, H: $t, v: Ct, n: en, j: on, o: sn, s: ln, D: dn, t: an, d: tn, C: cn, e: un, f: nn }, Gt = await V();
    Gt._;
...
//# sourceMappingURL=lyr3DWorker-37WSDEWZ.js.map
